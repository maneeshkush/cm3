...
property[0] = "Powierzchnia";
unit[0] = ["akr", "ar", "hektar", "centymetr kwadratowy", "stopa kwadratowa", "cal kwadratowy", "kilometr kwadratowy", "metr kwadratowy", "mil kwadratowa", "jard kwadratowy", "stóp kwadratowych"];
...
defaultUnits[0] = ["akr", "mil kwadratowa"];
...
property[2] = "Masa (Waga)";
unit[2] = ["tona", "kilogram", "gram", "miligram", "tona [długa, UK]", "tona [krótka, US]", "centner [długi, UK]", "centner [krótki, US]", "ćwierć [UK]", "ćwierć [US]", "slug", "stone", "funt", "funt trojański", "uncja", "uncja trojańska", "Robie", "dram", "drachma", "punkt", "ziarno"];
...
defaultUnits[2] = ["kilogram", "funt"];

property[3] = "Ciśnienie";
unit[3] = ["atm", "bar", "mbar", "kgf/m2", "kgf/cm2", "kPa", "MPa", "Pa", "lbf/ft2", "psi", "torr", "ksi", "kilopascal [kPa]", "Pascal", "milimetr rtęci [0 °C]", "atmosfera [standard]", "atmosfera techniczna [at]", "Kolumna Wody [metry]", "kilogram-siła na metr kwadratowy", "dyna na centymetr kwadratowy", "gram-siła na centymetr kwadratowy", "kilogram-siła na centymetr kwadratowy", "kilogram-siła na milimetr kwadratowy", "kilopond na metr kwadratowy", "milibar", "newton na metr kwadratowy", "uncja na cal kwadratowy", "funt na stopę kwadratową", "funt na cal kwadratowy", "poundal na stopę kwadratową", "atmosfera techniczna", "tona na metr kwadratowy", "Kolumna Wody [centymetry]", "Kolumna Wody [cali]", "Kolumna Wody [milimetry]"];
...
defaultUnits[3] = ["funt na cal kwadratowy", "kilopascal [kPa]"];
...
property[5] = "Objętość i Pojemność";
unit[5] = ["metr sześcienny","litr","litr","centylitr","mililitr","cc","centymetr sześcienny","mikrolitr","filiżanka [metryczna]","łyżka stołowa [metryczna]","łyżeczka stołowa [metryczna]","beczka","wiadro","beczka [UK]","wiadro [UK]","buszel [UK]","stopa sześcienna","cal sześcienny","milę sześcienną","filiżanka","dram","piątka","galon [płyn]","galon [UK]","ćwierć [US]","ćwierć [UK]","minim","uncja","uncja [UK, płyn]","peck [UK]","peck [US]","pinta","pinta [UK]","kwarta","Robie","strzał","łyżka stołowa","łyżeczka stołowa","łyżka stołowa [UK]","łyżeczka stołowa [UK]"];
...
defaultUnits[5] = ["litr", "uncja"];

property[6] = "Przyspieszenie";
unit[6] = ["metr na sekundę kwadratowy","stopa na sekundę kwadratowy","przyspieszenie grawitacyjne","Galileo","cal na sekundę kwadratowy"];
factor[6] = [1,0.3048,9.80665,0.01,0.0254];
defaultUnits[6] = ["metr na sekundę kwadratowy", "stopa na sekundę kwadratowy"];

property[7] = "Pojemność elektryczna";
...
property[8] = "Gęstość i Pojemność masowa";
unit[8] = ["gram na centymetr sześcienny","gram na litr","gram na mililitr","kilogram na litr","kilogram na metr sześcienny","tona na metr sześcienny","miligram na litr","miligram na mililitr","uncja na cal sześcienny","uncja na galon [UK]","uncja na galon [US]","funt na cal sześcienny","funt na galon [UK]","funt na galon [US]"];
...
defaultUnits[8] = ["kilogram na metr sześcienny","funt na galon [US]"];

property[9] = "Ładunek elektryczny";
unit[9] = ["Coulomb [C]", "abcoulomb", "Amperogodzina [A.hr]"];
factor[9] = [1, 10, 3600];
defaultUnits[9] = ["Coulomb [C]", "Amperogodzina [A.hr]"];

property[10] = "Energia";
unit[10] = ["Btu", "kaloria (żywieniowa)", "kaloria (termochemiczna)", "galon (US) LPG", "koń mechaniczny-godzina", "Joule", "kilogram-siła metr", "kilowatogodzina", "tona (wybuchowa)", "watogodzina"];
factor[10] = [1055.0559, 4186.8, 4.184, 100757838.45, 2684519.5, 1, 9.80665, 3600000, 4184000000, 3600];
defaultUnits[10] = ["Joule", "kilowatogodzina"];

property[11] = "Siła";
unit[11] = ["Newton (N)", "Dyne (dy)", "Kilogram-siła (kgf)", "Kilopond (kpf)", "Kip (k)", "Uncja siłowa (ozf)", "Funt siłowy (lbf)", "Poundal"];
factor[11] = [1, 0.00001, 9.806650, 9.806650, 4448.222, 0.2780139, 4.4482216, 0.138255];
defaultUnits[11] = ["Kilogram-siła (kgf)", "Newton (N)"];

property[12] = "Siła / Długość";
unit[12] = ["Newton na metr (N/m)", "funt siłowy na cal (lbf/in)", "funt siłowy na stopę (lbf/ft)"];
factor[12] = [1, 175.1268, 14.5939];
defaultUnits[12] = ["Newton na metr (N/m)", "funt siłowy na cal (lbf/in)"];

property[13] = "Iluminacja";
unit[13] = ["lumen/m² (lu/m²)","lumen/cm²","lumen/ft²","stopa-świecznik (ft-cdl)","świecznik-stopa (ft-lambert)","candela/m²","candela/cm²","lux (lx)","nox (nx)","phot (ph)"];
factor[13] = [1,10000,10.76391,10.76391,10.76391,3.141592505,31415.92505,1,-328716,10000];
defaultUnits[13] = ["lumen/m² (lu/m²)","lumen/ft²"];

property[14] = "Przepływ masy";
unit[14] = ["kilogram na sekundę (kg/s)","funt masy na sekundę (lbm/s)","funt masy na minutę (lbm/min)",];
factor[14] = [1, 0.4535924, 0.007559873];
defaultUnits[14] = ["kilogram na sekundę (kg/s)", "funt masy na sekundę (lbm/s)"];

property[15] = "Moc";
unit[15] = ["Btu/godzina","kaloria/godzina","gigawat","koń mechaniczny (elektryczny)","koń mechaniczny (międzynarodowy)","koń mechaniczny (metryczny)","koń mechaniczny (wodny)","kilokaloria/godzina","kilowat","megawat","mikrowat","miliwat","tona chłodnicza","watt"];
...
defaultUnits[15] = ["koń mechaniczny (elektryczny)","watt"];

property[16] = "Moment obrotowy";
unit[16] = ["Newton-metr (N.m)","dyne-centymetr(dy.cm)","kgf-metr (kgf.m)","lbf-cal (lbf.in)","lbf-stopa (lbf.ft)"];
factor[16] = [1, 0.0000001, 9.806650, 0.1129848, 1.355818];
defaultUnits[16] = ["Newton-metr (N.m)","kgf-metr (kgf.m)"];

property[17] = "Czas";
unit[17] = ["Sekunda (sec)", "Dzień (średni słoneczny)", "Dzień (sideralny)", "Godzina (średnia słoneczna)", "Godzina (sideralna)", "Minuta (średnia słoneczna)", "Minuta (sideralna)", "Miesiąc (średni kalendarzowy)", "Sekunda (sideralna)", "Rok (kalendarzowy)", "Rok (tropikalny)", "Rok (sideralny)"];
factor[17] = [1, 8.640E4, 86164.09, 3600, 3590.17, 60, 60, 2628000, 0.9972696, 31536000, 31556930, 31558150];
defaultUnits[17] = ["Dzień (średni słoneczny)", "Sekunda (sec)"];

property[18] = "Prędkość";
unit[18] = ["kilometr na sekundę", "kilometr na godzinę", "centymetr na sekundę", "metr na sekundę", "metr na minutę", "stopa na sekundę", "stopa na minutę", "stopa na godzinę", "mila na godzinę", "mila na sekundę", "mila morska na godzinę", "jard na sekundę", "węzeł", "mach", "prędkość światła [powietrze]", "prędkość światła [próżnia]", "prędkość dźwięku [powietrze]"];
...
defaultUnits[18] = ["kilometr na godzinę", "mila na godzinę"];

property[19] = "Lepkość";
unit[19] = ["Niuton-sekunda na metr", "centypoise", "centistoke", "stopa kwadratowa na sekundę", "Poise", "poundal-sekunda na stopę kwadratową", "funt masa na stopę-sekunda", "funt-siła-sekunda na stopę kwadratową", "rhe", "slug na stopę-sekunda", "stoke"];
factor[19] = [1, 0.001, 0.000001, 9.290304E-02, 0.1, 1.488164, 1.488164, 47.88026, 10, 47.88026, 0.0001];
defaultUnits[19] = ["Niuton-sekunda na metr", "poundal-sekunda na stopę kwadratową"];

property[20] = "Przepływ objętości";
unit[20] = ["beczka na minutę [UK]", "beczka na minutę [US]", "centymetr sześcienny na sekundę", "stóp sześcienny na sekundę", "metr sześcienny na sekundę", "milimetr sześcienny na sekundę", "galon na sekundę [UK]", "galon na sekundę [US]", "litr na sekundę", "mililitr na sekundę"];
...
defaultUnits[20] = ["stóp sześcienny na minutę", "metr sześcienny na sekundę"];

property[21] = "Kąt";
unit[21] = ["stopień", "grad", "radian", "1/10 okręgu", "1/16 okręgu", "1/2 okręgu", "1/4 okręgu", "1/6 okręgu", "1/8 okręgu", "minuta kątowa", "stopień binarny", "radian binarny", "cykl", "pełny kąt", "gradian [grad]", "mil", "milimetr kątowy", "milisekunda kątowa", "minuta kątowa", "oktant", "punkt", "kwadrant", "kąt prosty", "sekunda kątowa", "sextant", "znak", "kąt prosty"];
...
defaultUnits[21] = ["radian", "stopień"];
...
function clearResults() {
	...
	document.getElementById("verbose").innerHTML = "<span class='destacado'>Proszę wybrać ilość fizyczną, dwie jednostki, a następnie wprowadzić wartość w jednym z pól powyżej.</span>";
}
...
function explain(qTxt, from, to, converted) {
    ...
    var ret = "";
    if (q == 0) { return ""; } // cannot calculate the 'factor'

    var factor = parseFloat((converted / q).toPrecision(14)); // parseFloat removes trailing zeros.
    // 14 is the length of the number returned by the PHP function in the file xxxxx-unit-process.php
    var factorTxt = conversionFactorTxt(factor, 1E-8);
    var inv = 1 / factor;
    var invFact = roundDec(inv, 12);

    if (invFact % 1 === 0 && float2rat_p_error(invFact, 1E-8) === 0 && invFact > 0) { // checks if it's an integer // invFact can be zero if 'factor' is too large (> 10^12)

        ret += "<p><span class='destacado'>Formula:</span> dzieli wartość w " + pluralForConverters(from, 2) + " przez " + invFact + ", ponieważ 1 " + to + " równa się " + invFact + " " + pluralForConverters(from, 2) + ".</p>";

        ret += "<p>Zatem " + qTxt + " " + pluralForConverters(from, q) + " = <span class='fraction'><span class='top'>" + qTxt + "</span><span class='bottom'>" + invFact + "</span></span> = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? (" lub <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";

    } else {

        ret = "<p><span class='destacado'>Formula:</span> mnoży wartość w " + pluralForConverters(from, 2) + " przez współczynnik konwersji '" + factorTxt + "'.</p>";

        ret += "<p>Zatem " + qTxt + " " + pluralForConverters(from, q) + " = " + qTxt + " × " + factorTxt + " = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? (" lub <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";
...
function explainTemperature(val, from, to) {
  ...
  if (from == to) {
    return "Proszę wybrać dwie różne jednostki.";
  }

  var how = "<h3>Jak przeliczyć " + val + " " + from + " na " + to + "?<\/h3>";
  how += "<p>Aby przeliczyć " + from + " na " + to + ", użyj wzoru: <\/p><p><span class=\"formula\">" + temperatureFormula(tuple) + "<\/span><\/p>";

  if (tuple == "Celsius_Fahrenheit") {
    //"Celsius Fahrenheit":q*9/5+32,
    how += "<p>Stąd, mnożąc wartość '" + val + "' w " + from + " przez 9, dzieląc wynik przez 5, a następnie dodając 32, otrzymujemy:<\/p><p>";
    ...
    how += "<p>Stąd, dodając 273.15 do wartości '" + val + "' w " + from + ", otrzymujemy <\/p><p>";
    how += val + " " + from + " = " + val + " + 273.15 = " + roundDec(val + 273.15, dec) + " " + to + ".";
  } else if (tuple == "Kelvin_Celsius") {
    //"Kelvin Celsius":q-273.15,
    how += "<p>Stąd, odejmując 273.15 od wartości '" + val + "' w " + from + ", otrzymujemy <\/p><p>";
    how += val + " " + from + " = " + val + " - 273.15 = " + roundDec(val - 273.15, dec) + " " + to + ".";
  } else if (tuple == "Kelvin_Fahrenheit") {
    //"Kelvin Fahrenheit":q*9/5-459.67,
    how += "<p>Stąd, mnożąc wartość '" + val + "' w " + from + " przez 9, dzieląc wynik przez 5 i odejmując -459.67, otrzymujemy<\/p><p>";
    ...
    how += "<p>Stąd, odejmując 32 od wartości '" + val + "' w " + from + ", mnożąc wynik przez 5, a następnie dzieląc przez 9, otrzymujemy<\/p><p>";
    ...
    how += "<p>Stąd, dodając 459.67 do wartości '" + val + "' w " + from + ", mnożąc wynik przez 5 i dzieląc przez 9, otrzymujemy<\/p><p>";
...
function usableFractionsVerbose(x, from, to, qTxt) {
	...
	ret = "<h3>" + qTxt + " " + pluralForConverters(from, q) + " jako użyteczny ułamek lub liczba całkowita w " + pluralForConverters(to, 2) + ":</h3>" + near + "<p class='compact'>Są to alternatywne wartości dla " + qTxt + " " + pluralForConverters(from, q) + " w " + pluralForConverters(to) + ". Są one przedstawione jako ułamek lub liczba całkowita blisko dokładnej wartości (<span class='fraction'><span class='top'>1</span><span class='bottom'>2</span></span>, <span class='fraction'><span class='top'>1</span><span class='bottom'>4</span></span>, <span class='fraction'><span class='top'>3</span><span class='bottom'>4</span></span> itp.). Błąd przybliżenia, jeśli istnieje, znajduje się po prawej stronie wartości.</p>";
