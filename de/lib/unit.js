...
property[0] = "Fläche";
unit[0] = ["Acre", "Ar", "Hektar", "Quadratzentimeter", "Quadratfuß", "Quadratzoll", "Quadratkilometer", "Quadratmeter", "Quadratmeile", "Quadratyard", "Quadratfuß"];
...
defaultUnits[0] = ["Acre", "Quadratmeile"];
...
property[2] = "Masse (Gewicht)";
unit[2] = ["Tonne", "Kilogramm", "Gramm", "Milligramm", "Tonne [lang, UK]", "Tonne [kurz, US]", "Zentner [lang, UK]", "Zentner [kurz, US]", "Viertel [UK]", "Viertel [US]", "Slug", "Stein", "Pfund", "Troy-Pfund", "Unze", "Troy-Unze", "Robie", "Dram", "Drachme", "Punkt", "Grain"];
...
defaultUnits[2] = ["Kilogramm", "Pfund"];

property[3] = "Druck";
unit[3] = ["atm", "bar", "mbar", "kgf/m²", "kgf/cm²", "kPa", "MPa", "Pa", "lbf/ft²", "psi", "Torr", "ksi", "Kilopascal [kPa]", "Pascal", "Millimeter Quecksilbersäule [0 °C]", "Atmosphäre [Standard]", "Technische Atmosphäre [at]", "Wassersäule [Meter]", "Kilogramm-Kraft pro Quadratmeter", "Dyn/cm²", "Gramm-Kraft pro Quadratzentimeter", "Kilogramm-Kraft pro Quadratzentimeter", "Kilogramm-Kraft pro Quadratmillimeter", "Kilopond pro Quadratmeter", "Millibar", "Newton pro Quadratmeter", "Unze pro Quadratzoll", "Pfund pro Quadratfuß", "Pfund pro Quadratzoll", "Poundal pro Quadratfuß", "Technische Atmosphäre", "Tonne pro Quadratmeter", "Wassersäule [Zentimeter]", "Wassersäule [Zoll]", "Wassersäule [Millimeter]"];
...
defaultUnits[3] = ["Pfund pro Quadratzoll", "Kilopascal [kPa]"];
...
property[5] = "Volumen & Kapazität";
unit[5] = ["Kubikmeter","Liter","Liter","Zentiliter","Milliliter","cc","Kubikzentimeter","Mikroliter","Tasse [metrisch]","Esslöffel [metrisch]","Teelöffel [metrisch]","Fass","Eimer","Fass [UK]","Eimer [UK]","Scheffel [UK]","Kubikfuß","Kubikzoll","Kubikmeile","Tasse","Dram","Fünftel","Gallone [Flüssig]","Gallone [UK]","Gill [US]","Gill [UK]","Minim","Unze","Unze [UK, flüssig]","Scheffel [UK]","Scheffel [US]","Pint","Pint [UK]","Quart","Robie","Schuss","Esslöffel","Teelöffel","Esslöffel [UK]","Teelöffel [UK]"];
...
defaultUnits[5] = ["Liter", "Unze"];

property[6] = "Beschleunigung";
unit[6] = ["Meter pro Quadratsekunde","Fuß pro Quadratsekunde","Erdbeschleunigung","Galileo","Zoll pro Quadratsekunde"];
factor[6] = [1,0.3048,9.80665,0.01,0.0254];
defaultUnits[6] = ["Meter pro Quadratsekunde", "Fuß pro Quadratsekunde"];

property[7] = "Kapazität";
unit[7] = ["Farad [F]","Millifarad [mF]","Mikrofarad [µF]","Nanofarad [nF]","Picofarad [pF]"];
factor[7] = [1, 1E-3, 1E-6, 1E-9, 1E-12];
defaultUnits[7] = ["Mikrofarad [µF]", "Nanofarad [nF]"];

property[8] = "Dichte und Massenkapazität";
unit[8] = ["Gramm pro Kubikzentimeter", "Gramm pro Liter", "Gramm pro Milliliter", "Kilogramm pro Liter", "Kilogramm pro Kubikmeter", "Tonne pro Kubikmeter", "Milligramm pro Liter", "Milligramm pro Milliliter", "Unze pro Kubikzoll", "Unze pro Gallone [UK]", "Unze pro Gallone [US]", "Pfund pro Kubikzoll", "Pfund pro Gallone [UK]", "Pfund pro Gallone [US]"];
...
defaultUnits[8] = ["Kilogramm pro Kubikmeter", "Pfund pro Gallone [US]"];

property[9] = "Elektrische Ladung";
unit[9] = ["Coulomb [C]", "Abcoulomb", "Ampere-Stunde [A.hr]"];
factor[9] = [1, 10, 3600];
defaultUnits[9] = ["Coulomb [C]", "Ampere-Stunde [A.hr]"];

property[10] = "Energie";
unit[10] = ["Btu", "Kalorie (ernährungsphysiologisch)", "Kalorie (thermochemisch)", "Gallone (US) Flüssiggas", "Pferdestundenstunde", "Joule", "Kilogramm-Kraftmeter", "Kilowattstunde", "Tonnen (explosiv)", "Wattstunde"];
factor[10] = [1055.0559, 4186.8, 4.184, 100757838.45, 2684519.5, 1, 9.80665, 3600000, 4184000000, 3600];
defaultUnits[10] = ["Joule", "Kilowattstunde"];

property[11] = "Kraft";
unit[11] = ["Newton (N)", "Dyn (dy)", "Kilogrammkraft (kgf)", "Kilopond (kpf)", "Kip (k)", "Unzenkraft (ozf)", "Pfundkraft (lbf)", "Poundal"];
factor[11] = [1, 0.00001, 9.806650, 9.806650, 4448.222, 0.2780139, 4.4482216, 0.138255];
defaultUnits[11] = ["Kilogrammkraft (kgf)", "Newton (N)"];

property[12] = "Kraft / Länge";
unit[12] = ["Newton pro Meter (N/m)", "Pfundkraft pro Zoll (lbf/in)", "Pfundkraft pro Fuß (lbf/ft)"];
factor[12] = [1, 175.1268, 14.5939];
defaultUnits[12] = ["Newton pro Meter (N/m)", "Pfundkraft pro Zoll (lbf/in)"];

property[13] = "Beleuchtungsstärke";
unit[13] = ["Lumen pro Quadratmeter (lu/m²)", "Lumen pro Quadratzentimeter", "Lumen pro Quadratfuß", "Fußkerze (ft-cdl)", "Fußlambert", "Candela pro Quadratmeter (cd/m²)", "Candela pro Quadratzentimeter", "Lux (lx)", "Nox (nx)", "Phot (ph)"];
factor[13] = [1, 10000, 10.76391, 10.76391, 10.76391, 3.141592505, 31415.92505, 1, -328716, 10000];
defaultUnits[13] = ["Lumen pro Quadratmeter (lu/m²)", "Lumen pro Quadratfuß (ft²)"];

property[14] = "Massenstrom";
unit[14] = ["Kilogramm pro Sekunde (kg/s)", "Pfund Masse pro Sekunde (lbm/s)", "Pfund Masse pro Minute (lbm/min)"];
factor[14] = [1, 0.4535924, 0.007559873];
defaultUnits[14] = ["Kilogramm pro Sekunde (kg/s)", "Pfund Masse pro Sekunde (lbm/s)"];

property[15] = "Leistung";
unit[15] = ["Btu/Stunde", "Kalorie/Stunde", "Gigawatt", "Pferdestärke (elektrisch)", "Pferdestärke (international)", "Pferdestärke (metrisch)", "Pferdestärke (Wasser)", "Kilokalorie/Stunde", "Kilowatt", "Megawatt", "Mikrowatt", "Milliwatt", "Kühltonne", "Watt"];
...
defaultUnits[15] = ["Pferdestärke (elektrisch)", "Watt"]

property[16] = "Drehmoment";
unit[16] = ["Newton-Meter (N.m)", "Dynenzentimeter (dyne·cm)", "kgf-Meter (kgf·m)", "lbf-Zoll (lbf·in)", "lbf-Fuß (lbf·ft)"];
factor[16] = [1, 0.0000001, 9.806650, 0.1129848, 1.355818];
defaultUnits[16] = ["Newton-Meter (N.m)", "kgf-Meter (kgf·m)"];

property[17] = "Zeit";
unit[17] = ["Sekunde (sec)", "Tag (durchschnittlicher Sonnenstand)", "Tag (siderisch)", "Stunde (durchschnittlicher Sonnenstand)", "Stunde (siderisch)", "Minute (durchschnittlicher Sonnenstand)", "Minute (siderisch)", "Monat (durchschnittlicher Kalender)", "Sekunde (siderisch)", "Jahr (Kalender)", "Jahr (tropisch)", "Jahr (siderisch)"];
factor[17] = [1, 8.640E4, 86164.09, 3600, 3590.17, 60, 60, 2628000, 0.9972696, 31536000, 31556930, 31558150];
defaultUnits[17] = ["Tag (durchschnittlicher Sonnenstand)", "Sekunde (sec)"];

property[18] = "Geschwindigkeit";
unit[18] = ["Kilometer pro Sekunde", "Kilometer pro Stunde", "Zentimeter pro Sekunde", "Meter pro Sekunde", "Meter pro Minute", "Fuß pro Sekunde", "Fuß pro Minute", "Fuß pro Stunde", "Meile pro Stunde", "Meile pro Sekunde", "Seemeile pro Stunde", "Yard pro Sekunde", "Knoten", "Mach", "Lichtgeschwindigkeit [Luft]", "Lichtgeschwindigkeit [Vakuum]", "Schallgeschwindigkeit [Luft]"];
...
defaultUnits[18] = ["Kilometer pro Stunde", "Meile pro Stunde"];

property[19] = "Viskosität";
unit[19] = ["Newton-Sekunde pro Meter", "Zentipoise", "Zentistoke", "Quadratfuß pro Sekunde", "Poise", "Poundal-Sekunde pro Quadratfuß", "Pfundmasse pro Fuß-Sekunde", "Pfundkraft-Sekunde pro Quadratfuß", "Rhe", "Slug pro Fuß-Sekunde", "Stoke"];
factor[19] = [1, 0.001, 0.000001, 9.290304E-02, 0.1, 1.488164, 1.488164, 47.88026, 10, 47.88026, 0.0001];
defaultUnits[19] = ["Newton-Sekunde pro Meter", "Poundal-Sekunde pro Quadratfuß"];

property[20] = "Volumenstrom";
unit[20] = ["Barrel pro Minute [UK]", "Barrel pro Minute [US]", "Kubikzentimeter pro Sekunde", "Kubikfuß pro Sekunde", "Kubikmeter pro Sekunde", "Kubikmillimeter pro Sekunde", "Gallone pro Sekunde [UK]", "Gallone pro Sekunde [US]", "Liter pro Sekunde", "Milliliter pro Sekunde"];
...
defaultUnits[20] = ["Kubikfuß pro Minute", "Kubikmeter pro Sekunde"];

property[21] = "Winkel";
unit[21] = ["Grad", "Gon", "Radian", "1/10 Kreis", "1/16 Kreis", "1/2 Kreis", "1/4 Kreis", "1/6 Kreis", "1/8 Kreis", "Bogenminute", "Binärgrad", "Binärradian", "Zyklus", "Voller Winkel", "Gradiant [Gon]", "Mil", "Millibogenminute", "Millibogensekunde", "Minute", "Oktant", "Punkt", "Quadrant", "Rechter Winkel", "Sekunde", "Sextant", "Sign", "Gestreckter Winkel"];
...
function clearResults() {
    ...
    document.getElementById("verbose").innerHTML = "<span class='destacado'>Bitte wählen Sie eine physikalische Größe, zwei Einheiten und geben Sie dann einen Wert in eines der Felder oben ein.</span>";
}
...
function explain(qTxt, from, to, converted) {
	...
	var ret = "";
	if (q == 0) { return ""; } // Kann den 'Faktor' nicht berechnen

	var factor = parseFloat((converted / q).toPrecision(14)); // parseFloat entfernt die Nullen auf der rechten Seite
	// 14 ist die Länge der Zahl, die von der PHP-Funktion in der Datei xxxxx-unit-process.php zurückgegeben wird
	var factorTxt = conversionFactorTxt(factor, 1E-8);
	var inv = 1 / factor;
	var invFact = roundDec(inv, 12);

	if (invFact % 1 === 0 && float2rat_p_error(invFact, 1E-8) === 0 && invFact > 0) { // Überprüfen, ob es eine Ganzzahl ist
		ret += "<p><span class='destacado'>Formel:</span> Teilen Sie den Wert in " + pluralForConverters(from, 2) + " durch " + invFact + ", denn 1 " + to + " entspricht " + invFact + " " + pluralForConverters(from, 2) + ".</p>";
		ret += "<p>Also, " + qTxt + " " + pluralForConverters(from, q) + " = <span class='fraction'><span class='top'>" + qTxt + "</span><span class='bottom'>" + invFact + "</span></span> = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? (" oder <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";

	} else {
		ret = "<p><span class='destacado'>Formel:</span> Multiplizieren Sie den Wert in " + pluralForConverters(from, 2) + " mit dem Umrechnungsfaktor '" + factorTxt + "'.</p>";
		ret += "<p>Also, " + qTxt + " " + pluralForConverters(from, q) + " = " + qTxt + " × " + factorTxt + " = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? (" oder <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";
	}
...
function explainTemperature(val, from, to) {
    ...
    if (from === to) {
        return "Bitte wählen Sie zwei verschiedene Einheiten.";
    }

    var how = "<h3>Wie wird " + val + " " + from + " in " + to + " umgerechnet?</h3>";
    how += "<p>Um " + from + " in " + to + " umzurechnen, verwenden Sie die Formel:</p><p><span class=\"formula\">" + temperatureFormula(tuple) + "</span></p>";

    if (tuple === "Celsius_Fahrenheit") {
        // "Celsius Fahrenheit": q*9/5+32,
        how += "<p>Daher erhalten wir, indem wir den Wert '" + val + "' in " + from + " mit 9 multiplizieren, das Ergebnis durch 5 teilen und 32 addieren:</p><p>";
        ...
        how += "<p>Daher erhalten wir, indem wir zu dem Wert '" + val + "' in " + from + " 273,15 hinzufügen:</p><p>";
        how += val + " " + from + " = " + val + " + 273,15 = " + roundDec(val + 273.15, dec) + " " + to + ".";
    } else if (tuple === "Kelvin_Celsius") {
        // "Kelvin Celsius": q-273.15,
        how += "<p>Daher erhalten wir, indem wir von dem Wert '" + val + "' in " + from + " 273,15 subtrahieren:</p><p>";
        how += val + " " + from + " = " + val + " - 273,15 = " + roundDec(val - 273.15, dec) + " " + to + ".";
    } else if (tuple === "Kelvin_Fahrenheit") {
        // "Kelvin Fahrenheit": q*9/5-459.67,
        how += "<p>Daher erhalten wir, indem wir den Wert '" + val + "' in " + from + " mit 9 multiplizieren, das Ergebnis durch 5 teilen und -459,67 subtrahieren:</p><p>";
        ...
        how += "<p>Daher erhalten wir, indem wir von dem Wert '" + val + "' in " + from + " 32 subtrahieren, das Ergebnis mit 5 multiplizieren und durch 9 teilen:</p><p>";
        ...
        how += "<p>Daher erhalten wir, indem wir zu dem Wert '" + val + "' in " + from + " 459,67 hinzufügen, das Ergebnis mit 5 multiplizieren und durch 9 teilen:</p><p>";
...
function usableFractionsVerbose(x, from, to, qTxt) {
	...
	ret = "<h3>" + qTxt + " " + pluralForConverters(from, q) + " als verwendbaren Bruch oder als ganze Zahl in " + pluralForConverters(to, 2) + ":</h3>" + near + "<p class='compact'>Dies sind alternative Werte für " + qTxt + " " + pluralForConverters(from, q) + " in " + pluralForConverters(to) + ". Sie werden als Bruch oder als ganze Zahl dargestellt, die dem genauen Wert nahe kommt (<span class='fraction'><span class='top'>1</span><span class='bottom'>2</span></span>, <span class='fraction'><span class='top'>1</span><span class='bottom'>4</span></span>, <span class 'fraction'><span class='top'>3</span><span class='bottom'>4</span></span> usw.). Der Näherungsfehler, wenn vorhanden, steht rechts neben dem Wert.</p>";
