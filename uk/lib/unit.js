...
property[0] = "Площа";
unit[0] = ["акр", "ар", "гектар", "квадратний сантиметр", "квадратний фут", "квадратний дюйм", "квадратний кілометр", "квадратний метр", "квадратна миля", "квадратний ярд", "квадратний фут"];
...
defaultUnits[0] = ["акр", "квадратна миля"];
...
property[2] = "Маса (Вага)";
unit[2] = ["тонна", "кілограм", "грам", "міліграм", "тонна [довга, Великобританія]", "тонна [коротка, США]", "центнер [довгий, Великобританія]", "центнер [короткий, США]", "квартер [Великобританія]", "квартер [США]", "слаг", "камінь", "фунт", "тройський фунт", "унція", "тройська унція", "Робі", "драм", "драхма", "пункт", "зерно"];
...
defaultUnits[2] = ["кілограм", "фунт"];

property[3] = "Тиск";
unit[3] = ["атмосфера", "бар", "мілібар", "кгс/м²", "кгс/см²", "кПа", "МПа", "Па", "фунт/фут²", "фунт/дюйм²", "торр", "ксі", "кілопаскаль [кПа]", "Паскаль", "міліметр ртутного стовпа [0 °C]", "стандартна атмосфера", "технічна атмосфера", "водяний стовп [метр]", "кгс/м²", "дин/см²", "гф/см²", "кгс/см²", "кгс/мм²", "кілопонд/м²", "мілібар", "ньютон/м²", "унція/дюйм²", "фунт/фут²", "фунт/дюйм²", "фунтал/фут²", "технічна атмосфера", "тонна/м²", "водяний стовп [сантиметр]", "водяний стовп [дюйм]", "водяний стовп [міліметр]"];
...
defaultUnits[3] = ["фунт/дюйм²", "кілопаскаль [кПа]"];
...
property[5] = "Об'єм та ємність";
unit[5] = ["кубічний метр", "літр", "літр", "сантиметр кубічний", "мілілітр", "cc", "кубічний сантиметр", "мікролітр", "чашка [метрична]", "столова ложка [метрична]", "чайна ложка [метрична]", "барель", "ведро", "барель [UK]", "ведро [UK]", "бушель [UK]", "кубічний фут", "кубічний дюйм", "кубічна миля", "чашка", "драма", "п'ятита", "галлон [рідина]", "галлон [UK]", "гілл [US]", "гілл [UK]", "мінім", "унція", "унція [UK, рідина]", "пек [UK]", "пек [US]", "пінта", "пінта [UK]", "кварта", "Робі", "вистріл", "столова ложка", "чайна ложка", "столова ложка [UK]", "чайна ложка [UK]"];
...
defaultUnits[5] = ["літр", "унція"];

property[6] = "Прискорення";
unit[6] = ["метр на квадратну секунду", "фут на квадратну секунду", "сила тяжіння (прискорення)", "Галілео", "дюйм на квадратну секунду"];
factor[6] = [1, 0.3048, 9.80665, 0.01, 0.0254];
defaultUnits[6] = ["метр на квадратну секунду", "фут на квадратну секунду"];

property[7] = "Ємність";
unit[7] = ["Фарадей [F]", "міліфарадей [mF]", "мікрофарадей [µF]", "манофарадей [nF]", "пікофарадей [pF]"];
factor[7] = [1, 1E-3, 1E-6, 1E-9, 1E-12];
defaultUnits[7] = ["мікрофарадей [µF]", "нанофарадей [nF]"];

property[8] = "Густина та масова ємність";
unit[8] = ["грам на кубічний сантиметр", "грам на літр", "грам на мілілітр", "кілограм на літр", "кілограм на кубічний метр", "тонна на кубічний метр", "міліграм на літр", "міліграм на мілілітр", "унція на кубічний дюйм", "унція на галлон [UK]", "унція на галлон [US]", "фунт на кубічний дюйм", "фунт на галлон [UK]", "фунт на галлон [US]"];
...
defaultUnits[8] = ["кілограм на кубічний метр", "фунт на галлон [US]"];

property[9] = "Електричний Заряд";
unit[9] = ["Кулон [К]", "Абкулон", "Ампер-година [А.год]"];
factor[9] = [1, 10, 3600];
defaultUnits[9] = ["Кулон [К]", "Ампер-година [А.год]"];

property[10] = "Енергія";
unit[10] = ["Британська термічна одиниця [Btu]", "Калорія (харчова)", "Калорія (теплотехнічна)", "Галон (США) пального газу [галон LPG]", "Кінсько-силова година", "Джоуль", "Кілограм-сила метр", "Кіловат-година", "Тонна (вибухова)", "Ватт-година"];
factor[10] = [1055.0559, 4186.8, 4.184, 100757838.45, 2684519.5, 1, 9.80665, 3600000, 4184000000, 3600];
defaultUnits[10] = ["Джоуль", "Кіловат-година"];

property[11] = "Сила";
unit[11] = ["Ньютон (Н)", "Дин (дн)", "Кілограм-сила (кгс)", "Кілопонд (кп)", "Кіп (к)", "Унція-сила (унц)", "Фунт-сила (фунт)", "Фунталь"];
factor[11] = [1, 0.00001, 9.806650, 9.806650, 4448.222, 0.2780139, 4.4482216, 0.138255];
defaultUnits[11] = ["Кілограм-сила (кгс)", "Ньютон (Н)"];

property[12] = "Сила / Довжина";
unit[12] = ["Ньютон на метр (Н/м)", "Фунт-сила на дюйм (фунт/дюйм)", "Фунт-сила на фут (фунт/фут)"];
factor[12] = [1, 175.1268, 14.5939];
defaultUnits[12] = ["Ньютон на метр (Н/м)", "Фунт-сила на дюйм (фунт/дюйм)"];

property[13] = "Освітленість";
unit[13] = ["Люмен на метр квадратний (лм/м²)", "Люмен на сантиметр квадратний", "Люмен на фут квадратний", "Фут-свіч (фт-св)", "Фут-ламберт", "Кандела на метр квадратний", "Кандела на сантиметр квадратний", "Люкс (лк)", "Нокс (нкс)", "Фот (фт)"];
factor[13] = [1, 10000, 10.76391, 10.76391, 10.76391, 3.141592505, 31415.92505, 1, -328716, 10000];
defaultUnits[13] = ["Люмен на метр квадратний (лм/м²)", "Люмен на фут квадратний (лм/фт²)"];

property[14] = "Масовий потік";
unit[14] = ["кілограм за секунду (кг/с)", "фунт маси за секунду (фт/с)", "фунт маси за хвилину (фт/хв)"];
factor[14] = [1, 0.4535924, 0.007559873];
defaultUnits[14] = ["кілограм за секунду (кг/с)", "фунт маси за секунду (фт/с)"];

property[15] = "Потужність";
unit[15] = ["Бтю/година", "калорія/година", "гігават", "кінська сила (електрична)", "кінська сила (міжнародна)", "кінська сила (метрична)", "кінська сила (водна)", "кілокалорія/година", "кіловат", "мегават", "мікроват", "міліват", "тонна охолодження", "ват"];
...
defaultUnits[15] = ["кінська сила (електрична)", "ват"];

property[16] = "Крутний момент";
unit[16] = ["Ньютон-метр (Н·м)", "дин-сантиметр (дін·см)", "кілограм-сила метр (кгс·м)", "фунт-сила дюйм (фт·дюйм)", "фунт-сила фут (фт·фт)"];
factor[16] = [1, 0.0000001, 9.806650, 0.1129848, 1.355818];
defaultUnits[16] = ["Ньютон-метр (Н·м)", "кілограм-сила метр (кгс·м)"];

property[17] = "Час";
unit[17] = ["Секунда (сек)", "День (середнє сонячне)", "День (зірковий)", "Година (середнє сонячне)", "Година (зіркова)", "Хвилина (середнє сонячне)", "Хвилина (зіркова)", "Місяць (середній календарний)", "Секунда (зіркова)", "Рік (календарний)", "Рік (тропічний)", "Рік (зірковий)"];
factor[17] = [1, 8.640E4, 86164.09, 3600, 3590.17, 60, 60, 2628000, 0.9972696, 31536000, 31556930, 31558150];
defaultUnits[17] = ["День (середнє сонячне)", "Секунда (сек)"];

property[18] = "Швидкість і Спід";
unit[18] = ["кілометр за секунду","кілометр за годину","сантиметр за секунду","метр за секунду","метр за хвилину","фут за секунду","фут за хвилину","фут за годину","миля за годину","миля за секунду","морська миля за годину","ярд за секунду","вузол","мах","швидкість світла [в повітрі]","швидкість світла [вакуум]","швидкість звуку [в повітрі]"];
...
defaultUnits[18] = ["кілометр за годину","миля за годину"];

property[19] = "В'язкість";
unit[19] = ["Ньютон-секунда на метр","сантіпойз","сантісток","квадратний фут на секунду","пойз","фундаль-секунда на квадратний фут","фунд на фут-секунду","фундаль-сила-секунда на квадратний фут","ре","слаг на фут-секунду","сток"];
factor[19] = [1, 0.001, 0.000001, 9.290304E-02, 0.1, 1.488164, 1.488164, 47.88026, 10, 47.88026, 0.0001];
defaultUnits[19] = ["Ньютон-секунда на метр","фундаль-секунда на квадратний фут"];

property[20] = "Об'ємний потік";
unit[20] = ["барель на хвилину [Великобританія]","барель на хвилину [США]","кубічний сантиметр на секунду","кубічний фут на секунду","кубічний метр на секунду","кубічний міліметр на секунду","галон на секунду [Великобританія]","галон на секунду [США]","літр на секунду","мілілітр на секунду"];
...
defaultUnits[20] = ["кубічний фут за хвилину","кубічний метр на секунду"];

property[21] = "Кут";
unit[21] = ["градус","град","радіан","1/10 кола","1/16 кола","1/2 кола","1/4 кола","1/6 кола","1/8 кола","дугова хвилина","бінарний градус","бінарний радіан","цикл","повний кут","градіан [град]","міль","мілідугова хвилина","мілісекунда дуги","хвилина","восьминний кут","точка","квадрант","прямий кут","секунда","шостинний кут","знак","прямий кут"];
...
function clearResults() {
	...
	document.getElementById("verbose").innerHTML = "<span class='destacado'>Будь ласка, оберіть фізичну величину, дві одиниці вимірювання та введіть значення в одне з полів вище.</span>";
}
...
function explain(qTxt, from, to, converted) {
    ...
    var ret = "";
    if (q == 0) {
        return ""; // не може розрахувати 'фактор'
    }

    var factor = parseFloat((converted / q).toPrecision(14)); // parseFloat видаляє праворуч нулі. 14 - довжина числа, що повертається функцією PHP в файлі xxxxx-unit-process.php
    var factorTxt = conversionFactorTxt(factor, 1E-8);
    var inv = 1 / factor;
    var invFact = roundDec(inv, 12);

    if (invFact % 1 === 0 && float2rat_p_error(invFact, 1E-8) === 0 && invFact > 0) { // перевірка, чи це ціле число // invFact може бути нулем, якщо 'фактор' дуже великий ( > 10^12)

        ret += "<p><span class='destacado'>Формула:</span> поділити значення в " + pluralForConverters(from, 2) + " на " + invFact + ", оскільки 1 " + to + " дорівнює " + invFact + " " + pluralForConverters(from, 2) + ".</p>";

        ret += "<p>Отже, " + qTxt + " " + pluralForConverters(from, q) + " = <span class='fraction'><span class='top'>" + qTxt + "</span><span class='bottom'>" + invFact + "</span></span> = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) !== converted ? (" або <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";

    } else {

        ret = "<p><span class='destacado'>Формула:</span> помножте значення в " + pluralForConverters(from, 2) + " на фактор конвертації '" + factorTxt + "'.</p>";

        ret += "<p>Отже, " + qTxt + " " + pluralForConverters(from, q) + " = " + qTxt + " × " + factorTxt + " = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) !== converted ? (" або <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";
...
function explainTemperature(val, from, to) {
  ...
  if (from == to) {
    return "Будь ласка, оберіть дві різні одиниці.";
  }

  var how = "<h3>Як конвертувати " + val + " " + from + " в " + to + "?<\/h3>";
  how += "<p>Щоб конвертувати " + from + " в " + to + ", використовуйте формулу: <\/p><p><span class=\"formula\">" + temperatureFormula(tuple) + "<\/span><\/p>";

  if (tuple == "Celsius_Fahrenheit") {
    //"Celsius Fahrenheit":q*9/5+32,
    how += "<p>Отже, множимо значення '" + val + "' в " + from + " на 9, ділимо результат на 5, а потім додаємо 32, отримуємо:<\/p><p>";
    ...
    how += "<p>Отже, додаємо 273.15 до значення '" + val + "' в " + from + ", отримуємо <\/p><p>";
    how += val + " " + from + " = " + val + " + 273.15 = " + roundDec(val + 273.15, dec) + " " + to + ".";
  } else if (tuple == "Kelvin_Celsius") {
    //"Kelvin Celsius":q-273.15,
    how += "<p>Отже, віднімаємо 273.15 від значення '" + val + "' в " + from + ", отримуємо <\/p><p>";
    how += val + " " + from + " = " + val + " - 273.15 = " + roundDec(val - 273.15, dec) + " " + to + ".";
  } else if (tuple == "Kelvin_Fahrenheit") {
    //"Kelvin Fahrenheit":q*9/5-459.67,
    how += "<p>Отже, множимо значення '" + val + "' в " + from + " на 9, ділимо результат на 5 і віднімаємо 459.67, отримуємо<\/p><p>";
    ...
    how += "<p>Отже, віднімаємо 32 від значення '" + val + "' в " + from + ", множимо результат на 5, а потім ділимо на 9, отримуємо<\/p><p>";
    ...
    how += "<p>Отже, додаємо 459.67 до значення '" + val + "' в " + from + ", множимо результат на 5 і ділимо на 9, отримуємо<\/p><p>";
...
function usableFractionsVerbose(x, from, to, qTxt) {
	...
	ret = "<h3>" + qTxt + " " + pluralForConverters(from, q) + " у вигляді використовуваного дробу чи цілого числа в " + pluralForConverters(to, 2) + ":</h3>" + near + "<p class='compact'>Це альтернативні значення для " + qTxt + " " + pluralForConverters(from, q) + " в " + pluralForConverters(to) + ". Вони представлені у вигляді дробу чи цілого числа, близького до точного значення (<span class='fraction'><span class='top'>1</span><span class='bottom'>2</span></span>, <span class='fraction'><span class='top'>1</span><span class='bottom'>4</span></span>, <span class='fraction'><span class='top'>3</span><span class='bottom'>4</span></span> і т.д.). Похибка апроксимації, якщо є, знаходиться справа від значення.</p>";
