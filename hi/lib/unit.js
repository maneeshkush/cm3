...
property[0] = "क्षेत्रफल";
unit[0] = ["एकड़", "एकड़", "हेक्टेयर", "वर्ग सेंटीमीटर", "वर्ग फीट", "वर्ग इंच", "वर्ग किलोमीटर", "वर्ग मीटर", "वर्ग मील", "वर्ग यार्ड", "वर्ग फीट"];
...
property[2] = "मास (वजन)";
unit[2] = ["टन", "किलोग्राम", "ग्राम", "मिलीग्राम", "टन [लॉंग, यूके]", "टन [शॉर्ट, यूएस]", "सौ किलोग्राम [लॉंग, यूके]", "सौ किलोग्राम [शॉर्ट, यूएस]", "क्वार्टर [यूके]", "क्वार्टर [यूएस]", "स्लग", "स्टोन", "पाउंड", "ट्रॉय पाउंड", "औंस", "ट्रॉय औंस", "रोबी", "ड्रैम", "ड्रैक्मी", "पॉइंट", "ग्रेन"];
...
defaultUnits[2] = ["किलोग्राम", "पाउंड"];

property[3] = "दबाव";
unit[3] = ["एट्म", "बार", "मिलीबार", "किलोग्राम-बल प्रति वर्ग मीटर", "किलोग्राम-बल प्रति वर्ग सेंटीमीटर", "किलोपास्कल", "मेगापास्कल", "पास्कल", "पाउंड-फुट प्रति वर्ग फीट", "पाउंड प्रति वर्ग इंच", "टोर", "किलोपास्कल [केपीए]", "पास्कल", "मिलीमीटर हग्गुरी [0 °सी]", "मानवता [मानक]", "तकनीकी वायूमंडल [एट]", "पानी कॉलम [मीटर]", "किलोग्राम-बल प्रति वर्ग मीटर", "डाइन प्रति वर्ग सेंटीमीटर", "ग्राम-बल प्रति वर्ग सेंटीमीटर", "किलोग्राम-बल प्रति वर्ग सेंटीमीटर", "किलोग्राम-बल प्रति वर्ग मिलीमीटर", "किलोपॉन्ड प्रति वर्ग मीटर", "मिलीबार", "न्यूटन प्रति वर्ग मीटर", "इंच प्रति वर्ग इंच", "पाउंड प्रति वर्ग फीट", "पाउंड प्रति वर्ग इंच", "पाउंडल प्रति वर्ग फीट", "तकनीकी वायूमंडल", "टन प्रति वर्ग मीटर", "पानी कॉलम [सेंटीमीटर]", "पानी कॉलम [इंच]", "पानी कॉलम [मिलीमीटर]"];
...
defaultUnits[3] = ["पाउंड प्रति वर्ग इंच", "किलोपास्कल [केपीए]"];
...
property[5] = "आयतन और क्षमता";
unit[5] = ["क्यूबिक मीटर", "लीटर", "लीटर", "सेंटीलीटर", "मिलीलीटर", "सीसी", "सेंटीमीटर", "माइक्रोलीटर", "कप [मैट्रिक]", "टेबलस्पून [मैट्रिक]", "टीस्पून [मैट्रिक]", "बैरल", "बकेट", "बैरल [यूके]", "बकेट [यूके]", "बुशेल [यूके]", "क्यूबिक फुट", "क्यूबिक इंच", "क्यूबिक माइल", "कप", "द्रैम", "फिफ्थ", "गैलन [तरल]", "गैलन [यूके]", "गिल [यूएस]", "गिल [यूके]", "मिनिम", "औंस", "औंस [यूके, तरल]", "पेक [यूके]", "पेक [यूएस]", "पिंट", "पिंट [यूके]", "क्वार्ट", "रोबी", "शॉट", "टेबलस्पून", "टीस्पून", "टेबलस्पून [यूके]", "टीस्पून [यूके]"];
...
defaultUnits[5] = ["लीटर", "औंस"];

property[6] = "एतिरपण";
unit[6] = ["मीटर प्रति वर्ग सेकंड", "फुट प्रति वर्ग सेकंड", "गुरुत्व (एतिरपण)", "गैलिलियो", "इंच प्रति वर्ग सेकंड"];
factor[6] = [1, 0.3048, 9.80665, 0.01, 0.0254];
defaultUnits[6] = ["मीटर प्रति वर्ग सेकंड", "फुट प्रति वर्ग सेकंड"];

property[7] = "धारणा";
unit[7] = ["फैरेडे [F]", "मिलीफैरेडे [mF]", "माइक्रोफैरेडे [µF]", "मैनोफैरेडे [nF]", "पिकोफैरेडे [pF]"];
factor[7] = [1, 1E-3, 1E-6, 1E-9, 1E-12];
defaultUnits[7] = ["माइक्रोफैरेडे [µF]", "नैनोफैरेडे [nF]"];

property[8] = "घनत्व और भार क्षमता";
unit[8] = ["ग्राम प्रति क्यूबिक सेंटीमीटर", "ग्राम प्रति लीटर", "ग्राम प्रति मिलीलीटर", "किलोग्राम प्रति लीटर", "किलोग्राम प्रति क्यूबिक मीटर", "टन प्रति क्यूबिक मीटर", "मिलीग्राम प्रति लीटर", "मिलीग्राम प्रति मिलीलीटर", "औंस प्रति इंच", "औंस प्रति गैलन [यूके]", "औंस प्रति गैलन [यूएस]", "पाउंड प्रति इंच", "पाउंड प्रति गैलन [यूके]", "पाउंड प्रति गैलन [यूएस]"];
...
defaultUnits[8] = ["किलोग्राम प्रति क्यूबिक मीटर", "पाउंड प्रति गैलन [यूएस]"];

property[9] = "विद्युत आवेग";
unit[9] = ["कुलाम्ब [C]", "एब्कुलाम्ब", "एम्पीयर घंटा [ए.घंटा]"];
factor[9] = [1, 10, 3600];
defaultUnits[9] = ["कुलाम्ब [C]", "एम्पीयर घंटा [ए.घंटा]"];

property[10] = "ऊर्जा";
unit[10] = ["बीटू", "कैलरी (पोषणीय)", "कैलरी (थर्मोकैमिकल)", "गैलन (US) ऑफ़ LPG", "हॉर्सपावर-घंटा", "जूल", "किलोग्राम-बल मीटर", "किलोवॉट-घंटा", "टन (विस्फोटक)", "वॉट-घंटा"];
factor[10] = [1055.0559, 4186.8, 4.184, 100757838.45, 2684519.5, 1, 9.80665, 3600000, 4184000000, 3600];
defaultUnits[10] = ["जूल", "किलोवॉट-घंटा"];

property[11] = "बल";
unit[11] = ["न्यूटन (N)", "डाइन (डाइ)", "किलोग्राम बल (किग्राफोर्स)", "किलोपॉंड (केपीएफ)", "किप (के)", "आउंस फोर्स (ओज़एफ)", "पाउंड फोर्स (एलबीएफ)", "पाउंडल"];
factor[11] = [1, 0.00001, 9.806650, 9.806650, 4448.222, 0.2780139, 4.4482216, 0.138255];
defaultUnits[11] = ["किलोग्राम बल (किग्राफोर्स)", "न्यूटन (N)"];

property[12] = "बल / लम्बाई";
unit[12] = ["न्यूटन प्रति मीटर (N/m)", "पाउंड फोर्स प्रति इंच (एलबीएफ/इं)", "पाउंड फोर्स प्रति फुट (एलबीएफ/फ़्ट)"];
factor[12] = [1, 175.1268, 14.5939];
defaultUnits[12] = ["न्यूटन प्रति मीटर (N/m)", "पाउंड फोर्स प्रति इंच (एलबीएफ/इं)"];

property[13] = "प्रकाशता";
unit[13] = ["लूमेन/मीटर² (lu/m²)","लूमेन/सेंटीमीटर²","लूमेन/फीट²","फुट-कैंडल (ft-cdl)","फुट-लैम्बर्ट","कैंडेला/मीटर²","कैंडेला/सेंटीमीटर²","लक्स (lx)","नोक्स (nx)","फोट (ph)"];
factor[13] = [1,10000,10.76391,10.76391,10.76391,3.141592505,31415.92505,1,-328716,10000];
defaultUnits[13] = ["लूमेन/मीटर² (lu/m²)","लूमेन/फीट²"];

property[14] = "मास वायु";
unit[14] = ["किलोग्राम प्रति सेकंड (kg/s)","पौंड मास प्रति सेकंड (lbm/s)","पौंड मास प्रति मिनट (lbm/min)",];
factor[14] = [1, 0.4535924, 0.007559873];
defaultUnits[14] = ["किलोग्राम प्रति सेकंड (kg/s)", "पौंड मास प्रति सेकंड (lbm/s)"];

property[15] = "शक्ति";
unit[15] = ["बीटू/घंटा","कैलोरी/घंटा","गीगावॉट","हॉर्सपावर (विद्युतीय)","हॉर्सपावर (अंतरराष्ट्रीय)","हॉर्सपावर (मीट्रिक)","हॉर्सपावर (पानी)","किलोकैलोरी/घंटा","किलोवॉट","मेगावॉट","माइक्रोवॉट","मिलीवॉट","रिफ्रिजरेशन टन","वॉट"];
...
defaultUnits[15] = ["हॉर्सपावर (विद्युतीय)","वॉट"];

property[16] = "टॉर्क";
unit[16] = ["न्यूटन-मीटर (N.m)","डाइन-सेंटीमीटर(dy.cm)","किलोग्राम-बल-मीटर (kgf.m)","पौंड-बल-इंच (lbf.in)","पौंड-बल-फीट (lbf.ft)"];
factor[16] = [1, 0.0000001, 9.806650, 0.1129848, 1.355818];
defaultUnits[16] = ["न्यूटन-मीटर (N.m)","किलोग्राम-बल-मीटर (kgf.m)"];

property[17] = "समय";
unit[17] = ["सेकंड (सेक)", "दिन (मीयन सोलर)", "दिन (साइडेरियल)", "घंटा (मीयन सोलर)", "घंटा (साइडेरियल)", "मिनट (मीयन सोलर)", "मिनट (साइडेरियल)", "महीना (मीयन कैलेंडर)", "सेकंड (साइडेरियल)", "वर्ष (कैलेंडर)", "वर्ष (ट्रॉपिकल)", "वर्ष (साइडेरियल)"];
factor[17] = [1, 8.640E4, 86164.09, 3600, 3590.17, 60, 60, 2628000, 0.9972696, 31536000, 31556930, 31558150];
defaultUnits[17] = ["दिन (मीयन सोलर)", "सेकंड (सेक)"];

property[18] = "वेग और गति";
unit[18] = ["किलोमीटर प्रति सेकंड", "किलोमीटर प्रति घंटा", "सेंटीमीटर प्रति सेकंड", "मीटर प्रति सेकंड", "मीटर प्रति मिनट", "फीट प्रति सेकंड", "फीट प्रति मिनट", "फीट प्रति घंटा", "मील प्रति घंटा", "मील प्रति सेकंड", "नॉटिकल मील प्रति घंटा", "यार्ड प्रति सेकंड", "नॉट", "मैक", "वायु में प्रकाश की गति", "वैक्यूम में प्रकाश की गति", "वायु में ध्वनि की गति"];
...
defaultUnits[18] = ["किलोमीटर प्रति घंटा", "मील प्रति घंटा"];

property[19] = "घिसण";
unit[19] = ["न्यूटन-सेकंड प्रति मीटर", "सेंटिपॉइज", "सेंटिस्टोक", "वर्ग फुट प्रति सेकंड", "पोइज", "पौंडल-सेकंड प्रति वर्ग फुट", "पौंड मास प्रति फुट-सेकंड", "पौंड बल प्रति वर्ग फुट", "री", "स्लग प्रति फुट-सेकंड", "स्टोक"];
factor[19] = [1, 0.001, 0.000001, 9.290304E-02, 0.1, 1.488164, 1.488164, 47.88026, 10, 47.88026, 0.0001];
defaultUnits[19] = ["न्यूटन-सेकंड प्रति मीटर", "पौंडल-सेकंड प्रति वर्ग फुट"];

property[20] = "आयतन प्रवाह";
unit[20] = ["मिनट प्रति बैरल [यूके]", "मिनट प्रति बैरल [यूएस]", "सेंटीमीटर प्रति सेकंड", "क्यूबिक फीट प्रति सेकंड", "क्यूबिक मीटर प्रति सेकंड", "क्यूबिक मिलीमीटर प्रति सेकंड", "गैलन प्रति सेकंड [यूके]", "गैलन प्रति सेकंड [यूएस]", "लीटर प्रति सेकंड", "मिलीलीटर प्रति सेकंड"];
...
defaultUnits[20] = ["क्यूबिक फीट प्रति मिनट", "क्यूबिक मीटर प्रति सेकंड"];

property[21] = "कोण";
unit[21] = ["डिग्री", "ग्रैड", "रेडियन", "1/10 चक्र", "1/16 चक्र", "1/2 चक्र", "1/4 चक्र", "1/6 चक्र", "1/8 चक्र", "आर्क मिनट", "बाइनरी डिग्री", "बाइनरी रेडियन", "साइकिल", "पूर्ण कोण", "ग्रेडियन [ग्रैड]", "मिल", "मिलीआर्क मिनट", "आर्क का मिलीसेकंड", "मिनट", "आठवां", "बिंदु", "चतुर्थ", "दायाँ कोण", "सेकंड", "षष्ठांश", "साइन", "सीधा कोण"];
...
function clearResults() {
	...
	document.getElementById("verbose").innerHTML = "<span class='destacado'>कृपया, किसी भौतिक मात्रा का चयन करें, दो इकाइयों को और फिर किसी उपबॉक्स में मान दर्ज करें.</span>";
}
...
function explain(qTxt, from, to, converted) {
    ...
    var ret = "";
    if (q == 0) { return ""; } // फैक्टर की गणना नहीं कर सकते
    
    var factor = parseFloat((converted / q).toPrecision(14)); // parseFloat दहीने की ओर के शून्य हटा देता है।
    // 14 यह नंबर की लंबाई है जो फ़ाइल xxxxx-unit-process.php में फ़ंक्शन द्वारा वापस दिया जाता है
    var factorTxt = conversionFactorTxt(factor, 1E-8);
    var inv = 1 / factor;
    var invFact = roundDec(inv, 12);

    if (invFact % 1 === 0 && float2rat_p_error(invFact, 1E-8) === 0 && invFact > 0) { // संख्या के दशमला से पूरी संख्या के लिए जांच करें // invFact अगर फैक्टर बहुत बड़ा हो ( > 10^12) तो शून्य हो सकता है
        ret += "<p><span class='destacado'>सूत्र:</span> " + pluralForConverters(from, 2) + " में मौल्य को " + invFact + " से विभाजित करें क्योंकि 1 " + to + " " + pluralForConverters(from, 2) + " के बराबर होता है।</p>";
        ret += "<p>तो, " + qTxt + " " + pluralForConverters(from, q) + " = <span class='fraction'><span class='top'>" + qTxt + "</span><span class='bottom'>" + invFact + "</span></span> = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? (" या <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + "।</p>";
    } else {
        ret = "<p><span class='destacado'>सूत्र:</span> " + pluralForConverters(from, 2) + " में मौल्य को परिवर्तन गुणफल '" + factorTxt + "' से गुणा करें।</p>";
        ret += "<p>तो, " + qTxt + " " + pluralForConverters(from, q) + " = " + qTxt + " × " + factorTxt + " = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? (" या <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + "।</p>";
    }
    return ret;
}
...
function explainTemperature(val, from, to) {
  ...
  if (from == to) {
    return "कृपया दो विभिन्न इकाइयों का चयन करें।";
  }

  var how = "<h3>" + val + " " + from + " से " + to + " में कैसे परिवर्तित करें?</h3>";
  how += "<p>" + from + " से " + to + " परिवर्तित करने के लिए, निम्नलिखित सूत्र का प्रयोग करें:</p><p><span class=\"formula\">" + temperatureFormula(tuple) + "</span></p>";

  if (tuple == "Celsius_Fahrenheit") {
    //"Celsius Fahrenheit":q*9/5+32,
    how += "<p>इस तरह, " + from + " में मौजूद मूल्य '" + val + "' को 9 से गुना करें, परिणाम को 5 से विभाजित करें और 32 जोड़ें, हमें मिलता है:</p><p>";
    ...
    how += "<p>इस तरह, " + from + " में मौजूद मूल्य '" + val + "' को 273.15 जोड़ें, हमें मिलता है:</p><p>";
    how += val + " " + from + " = " + val + " + 273.15 = " + roundDec(val + 273.15, dec) + " " + to + ".";
  } else if (tuple == "Kelvin_Celsius") {
    //"Kelvin Celsius":q-273.15,
    how += "<p>इस तरह, " + from + " में मौजूद मूल्य '" + val + "' से 273.15 कम करें, हमें मिलता है:</p><p>";
    how += val + " " + from + " = " + val + " - 273.15 = " + roundDec(val - 273.15, dec) + " " + to + ".";
  } else if (tuple == "Kelvin_Fahrenheit") {
    //"Kelvin Fahrenheit":q*9/5-459.67,
    how += "<p>इस तरह, " + from + " में मौजूद मूल्य '" + val + "' को 9 से गुना करें, परिणाम को 5 से विभाजित करें और -459.67 कम करें, हमें मिलता है:</p><p>";
    ...
    how += "<p>इस तरह, " + from + " में मौजूद मूल्य '" + val + "' से 32 कम करें, परिणाम को 5 से गुना करें और 9 से विभाजित करें, हमें मिलता है:</p><p>";
    ...
    how += "<p>इस तरह, " + from + " में मौजूद मूल्य '" + val + "' में 459.67 जोड़ें, परिणाम को 5 से गुना करें और 9 से विभाजित करें, हमें मिलता है:</p><p>";
...
function usableFractionsVerbose(x, from, to, qTxt) {
	...
	ret = "<h3>" + qTxt + " " + pluralForConverters(from, q) + " को एक उपयोगी भिन्न या " + pluralForConverters(to, 2) + " में एक पूर्णांक के रूप में दिखाएं:</h3>" + near + "<p class='compact'>ये " + qTxt + " " + pluralForConverters(from, q) + " के लिए वैकल्पिक मूल्य हैं " + pluralForConverters(to) + " में। वे एक भिन्न या सटीक मूल्य के पास होते हैं (<span class='fraction'><span class='top'>1</span><span class='bottom'>2</span></span>, <span class='fraction'><span 'top'>1</span><span class='bottom'>4</span></span>, <span class='fraction'><span 'top'>3</span><span class='bottom'>4</span></span> आदि)। अपघातन त्रुटि, यदि कोई हो, मूल्य के दाईं ओर है।</p>";
