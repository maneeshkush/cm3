...
property[0] = "Alan";
unit[0] = ["akre", "ar", "hekter", "kare santimetre", "kare ayak", "kare inç", "kare kilometre", "kare metre", "kare mil", "kare yard", "kare fit"];
...
property[2] = "Kütle (Ağırlık)";
unit[2] = ["ton", "kilogram", "gram", "miligram", "ton [uzun, İngiltere]", "ton [kısa, ABD]", "cental [uzun, İngiltere]", "cental [kısa, ABD]", "çeyrek [İngiltere]", "çeyrek [ABD]", "slug", "stone", "pound", "troy pound", "ounce", "troy ounce", "Robie", "dram", "drachme", "point", "grain"];
...
property[3] = "Basınç";
unit[3] = ["atm", "bar", "mbar", "kgf/m2", "kgf/cm2", "kPa", "MPa", "Pa", "lbf/ft2", "psi", "torr", "ksi", "kilopascal [kPa]", "Pascal", "milimetre cıva [0 °C]", "atmosfer [standart]", "teknik atmosfer [at]", "Su Sütunu [metre]", "kilogram kuvveti per square meter", "dyne per square centimeter", "gram kuvveti per square centimeter", "kilogram kuvveti per square centimeter", "kilogram kuvveti per square millimeter", "kilopond per square meter", "millibar", "newton per square meter", "inç başına ons", "fit başına pound", "inç başına pound", "poundal başına fit", "teknik atmosfer", "ton başına square meter", "Su Sütunu [santimetre]", "Su Sütunu [inç]", "Su Sütunu [milimetre]"];
...
property[5] = "Hacim ve Kapasite";
unit[5] = ["metreküp","litre","litre","santimetre küp","mililitre","cc","santimetre küp","mikrolitre","fincan [metrik]","Yemek kaşığı [metrik]","Çay kaşığı [metrik]","varil","kova","varil [BK]","kova [BK]","buşel [BK]","fit küp","inç küp","mil küp","fincan","dram","beşinci","galon [sıvı]","galon [BK]","gill [ABD]","gill [BK]","minim","ons","ons [BK, sıvı]","peck [BK]","peck [ABD]","pint","pint [BK]","quart","Robie","atış","Yemek kaşığı","Çay kaşığı","Yemek kaşığı [BK]","Çay kaşığı [BK]"];
...
defaultUnits[5] = ["litre", "ons"];

property[6] = "İvme";
unit[6] = ["metre kare başına saniye","fit kare başına saniye","yerçekimi (ivme)","Galileo","inç kare başına saniye"];
factor[6] = [1,0.3048,9.80665,0.01,0.0254];
defaultUnits[6] = ["metre kare başına saniye", "fit kare başına saniye"];

property[7] = "Kapasitans";
unit[7] = ["Faraday [F]","milifaraday [mF]","mikrofaraday [µF]","nanofaraday [nF]","pikofaraday [pF]"];
factor[7] = [1, 1E-3, 1E-6, 1E-9, 1E-12];
defaultUnits[7] = ["mikrofaraday [µF]", "nanofaraday [nF]"];

property[8] = "Yoğunluk ve Kütle Kapasitesi";
unit[8] = ["gram kare başına santimetre küp","gram kare başına litre","gram kare başına mililitre","kilogram kare başına litre","kilogram kare başına metreküp","ton kare başına metreküp","miligram kare başına litre","miligram kare başına mililitre","ons kare başına inç küp","ons kare başına gallon [BK]","ons kare başına gallon [ABD]","pound kare başına inç küp","pound kare başına gallon [BK]","pound kare başına gallon [ABD]"];
...
defaultUnits[8] = ["kilogram kare başına metreküp","pound kare başına gallon [ABD]"];

property[9] = "Elektrik Yükü";
unit[9] = ["Coulomb [C]", "abcoulomb", "Ampere saat [A.saat]"];
factor[9] = [1, 10, 3600];
defaultUnits[9] = ["Coulomb [C]", "Ampere saat [A.saat]"];

property[10] = "Enerji";
unit[10] = ["Btu", "kalori (besin)", "kalori (termokimyasal)", "gallon (ABD) LPG", "beygir gücü-saat", "Joule", "kilogram kuvvet metre", "kilowatt-saat", "ton (patlayıcı)", "watt-saat"];
factor[10] = [1055.0559, 4186.8, 4.184, 100757838.45, 2684519.5, 1, 9.80665, 3600000, 4184000000, 3600];
defaultUnits[10] = ["Joule", "kilowatt-saat"];

property[11] = "Kuvvet";
unit[11] = ["Newton (N)", "Dyne (dy)", "Kilogram kuvvet (kgf)", "Kilopond (kpf)", "Kip (k)", "Ounce kuvvet (ozf)", "Pound kuvvet (lbf)", "Poundal"];
factor[11] = [1, 0.00001, 9.806650, 9.806650, 4448.222, 0.2780139, 4.4482216, 0.138255];
defaultUnits[11] = ["Kilogram kuvvet (kgf)", "Newton (N)"];

property[12] = "Kuvvet / Uzunluk";
unit[12] = ["Newton per metre (N/m)", "pound kuvvet per inch (lbf/in)", "pound kuvvet per foot (lbf/ft)"];
factor[12] = [1, 175.1268, 14.5939];
defaultUnits[12] = ["Newton per metre (N/m)", "pound kuvvet per inch (lbf/in)"];
...
property[14] = "Ağırlık Akışı";
unit[14] = ["kilogram/saniye (kg/s)", "pound kütlesi/saniye (lbm/s)", "pound kütlesi/dakika (lbm/dak)"];
factor[14] = [1, 0.4535924, 0.007559873];
defaultUnits[14] = ["kilogram/saniye (kg/s)", "pound kütlesi/saniye (lbm/s)"];

property[15] = "Güç";
unit[15] = ["Btu/saat", "kalori/saat", "gigawatt", " beygir gücü (elektrik)", "beygir gücü (uluslararası)", "beygir gücü (metrik)", "beygir gücü (su)", "kilokalori/saat", "kilowatt", "megawatt", "mikrowatt", "milivatt", "refrigeration tonu", "watt"];
...
defaultUnits[15] = ["beygir gücü (elektrik)", "watt"];

property[16] = "Tork";
unit[16] = ["Newton-metre (N.m)", "dyne-santimetre (dy.cm)", "kgf-metre (kgf.m)", "lbf-inç (lbf.in)", "lbf-fit (lbf.ft)"];
factor[16] = [1, 0.0000001, 9.806650, 0.1129848, 1.355818];
defaultUnits[16] = ["Newton-metre (N.m)", "kgf-metre (kgf.m)"];

property[17] = "Zaman";
unit[17] = ["Saniye (sn)", "Gün (ortalama güneş)", "Gün (sidereal)", "Saat (ortalama güneş)", "Saat (sidereal)", "Dakika (ortalama güneş)", "Dakika (sidereal)", "Ay (ortalama takvim)", "Saniye (sidereal)", "Yıl (takvim)", "Yıl (tropikal)", "Yıl (sidereal)"];
factor[17] = [1, 8.640E4, 86164.09, 3600, 3590.17, 60, 60, 2628000, 0.9972696, 31536000, 31556930, 31558150];
defaultUnits[17] = ["Gün (ortalama güneş)", "Saniye (sn)"];

property[18] = "Hız ve Hız";
unit[18] = ["kilometre/saniye","kilometre/saat","santimetre/saniye","metre/saniye","metre/dakika","fit/saniye","fit/dakika","fit/saat","mil/saat","mil/saniye","deniz mili/saat","yard/saniye","knot","mach","ışığın hızı [hava]","ışığın hızı [vakum]","sesin hızı [hava]"];
factor[18] = [1000,1000/3600,0.01,1,1/60,0.3048,0.3048/60,0.3048,(0.3048*5280)/3600,0.3048*5280,1852/3600,0.3048*3,1852/3600,340.29,299792458,340.29];
defaultUnits[18] = ["kilometre/saat","mil/saat"];

property[19] = "Viskozite";
unit[19] = ["Newton-saniye/metre","sentipoiz","sentistok","fitkare/saniye","Poise","poundal-saniye/fitkare","pound kütle/fit-saniye","pound kuvvet-saniye/fitkare","rhe","slug/fit-saniye","stok"];
factor[19] = [1, 0.001, 0.000001, 9.290304E-02, 0.1, 1.488164, 1.488164, 47.88026, 10, 47.88026, 0.0001];
defaultUnits[19] = ["Newton-saniye/metre","poundal-saniye/fitkare"];

property[20] = "Hacim Akışı";
unit[20] = ["varil/dakika [BK]","varil/dakika [ABD]","santimetre küp/saniye","fit küp/saniye","metre küp/saniye","milimetre küp/saniye","gallon/saniye [BK]","gallon/saniye [ABD]","litre/saniye","mililitre/saniye"];
...
defaultUnits[20] = ["fit küp/dakika","metre küp/saniye"];

property[21] = "Açı";
unit[21] = ["derece","grad","radyan","1/10 daire","1/16 daire","1/2 daire","1/4 daire","1/6 daire","1/8 daire","ark dakika","ikili derece","ikili radyan","devir","tam açı","gradyan [grad]","mil","miliradyan","milisaniye açı","dakika","oktant","nokta","kadrant","dik açı","saniye","sextant","işaret","doğrusal açı"];
...
function clearResults() {
	...
	document.getElementById("verbose").innerHTML = "<span class='destacado'>Lütfen bir fiziksel miktar seçin, iki birimi seçin ve ardından yukarıdaki kutulardan herhangi birine bir değer girin.</span>";
}
...
function explain(qTxt, from, to, converted) {
	...
	var ret = "";
	if (q == 0) {return "";} // 'faktör' hesaplanamaz
	 
	var faktor = parseFloat((converted / q).toPrecision(14)); // parseFloat sağdaki sıfırları kaldırır.
	//14, xxxxx-unit-process.php dosyasındaki PHP fonksiyonu tarafından döndürülen sayının uzunluğudur.
	var faktorTxt = conversionFactorTxt(faktor, 1E-8);
	var inv = 1 / faktor;
	var invFaktor = roundDec(inv, 12); 

	if (invFaktor % 1 === 0 && float2rat_p_error(invFaktor, 1E-8) === 0 && invFaktor > 0) { // bir tam sayı olup olmadığını kontrol et // invFaktor, 'faktör' çok büyükse ( > 10^12) 0 olabilir

		ret += "<p><span class='destacado'>Formül:</span> " + pluralForConverters(from, 2) + " içindeki değeri " + invFaktor + " ile böler, çünkü 1 " + to + ", " + invFaktor + " " + pluralForConverters(from, 2) + " eşittir.</p>";

		ret += "<p>Dolayısıyla, " + qTxt + " " + pluralForConverters(from, q) + " = <span class='fraction'><span class='top'>" + qTxt + "</span><span class='bottom'>" + invFaktor + "</span></span> = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? (" veya <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";

	} else {

		ret = "<p><span class='destacado'>Formül:</span> " + pluralForConverters(from, 2) + " içindeki değeri '" + faktorTxt + "' dönüşüm faktörü ile çarpar.</p>";

		ret += "<p>Dolayısıyla, " + qTxt + " " + pluralForConverters(from, q) + " = " + qTxt + " × " + faktorTxt + " = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? (" veya <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";
...
function explainTemperature(val, from, to) {
  ...
  if (from == to) {
    return "Lütfen farklı iki birim seçin.";
  }

  var how = "<h3>Nasıl çevrilir: " + val + " " + from + "'dan " + to + "'ya?</h3>";
  how += "<p>" + from + "'dan " + to + "'ya çevirmek için formülü kullanın: </p><p><span class=\"formula\">" + temperatureFormula(tuple) + "</span></p>";

  if (tuple == "Celsius_Fahrenheit") {
    //"Celsius Fahrenheit":q*9/5+32,
    how += "<p>Böylece, '" + val + "' değerini " + from + "'da 9 ile çarparız, sonucu 5'e böleriz ve ardından 32 ekleriz, böylece şu elde edilir:</p><p>";
    ...
    how += "<p>Böylece, '" + val + "' değerine " + from + "'da 273.15 ekleriz, böylece şu elde edilir:</p><p>";
    how += val + " " + from + " = " + val + " + 273.15 = " + roundDec(val + 273.15, dec) + " " + to + ".";
  } else if (tuple == "Kelvin_Celsius") {
    //"Kelvin Celsius":q-273.15,
    how += "<p>Böylece, '" + val + "' değerinden " + from + "'da 273.15 çıkarırız, böylece şu elde edilir:</p><p>";
    how += val + " " + from + " = " + val + " - 273.15 = " + roundDec(val - 273.15, dec) + " " + to + ".";
  } else if (tuple == "Kelvin_Fahrenheit") {
    //"Kelvin Fahrenheit":q*9/5-459.67,
    how += "<p>Böylece, '" + val + "' değerini " + from + "'da 9 ile çarparız, sonucu 5'e böleriz ve ardından -459.67 çıkarırız, böylece şu elde edilir:</p><p>";
    ...
    how += "<p>Böylece, '" + val + "' değerinden " + from + "'da 32 çıkarır, sonucu 5 ile çarpar ve ardından 9'a böleriz, böylece şu elde edilir:</p><p>";
    ...
    how += "<p>Böylece, '" + val + "' değerine " + from + "'da 459.67 ekleriz, sonucu 5 ile çarparız ve ardından 9'a böleriz, böylece şu elde edilir:</p><p>";
...
function usableFractionsVerbose(x, from, to, qTxt) {
	...
	ret = "<h3>" + qTxt + " " + pluralForConverters(from, q) + " bir kullanılabilir kesir veya tam sayı olarak " + pluralForConverters(to, 2) + ":</h3>" + near + "<p class='compact'>" + qTxt + " " + pluralForConverters(from, q) + " için alternatif değerler " + pluralForConverters(to) + " içindir. Bunlar, kesir veya tam sayı olarak temsil edilmiştir ve tam değere yakın değerlerdir (<span class='fraction'><span class='top'>1</span><span class='bottom'>2</span></span>, <span class='fraction'><span class='top'>1</span><span class='bottom'>4</span></span>, <span class='fraction'><span class='top'>3</span><span class='bottom'>4</span></span> vb.). Var ise yaklaşık hata, değerin sağında yer almaktadır.</p>";
