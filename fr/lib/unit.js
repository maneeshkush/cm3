...
property[0] = "Surface";
unit[0] = ["acre", "are", "hectare", "centimètre carré", "pied carré", "pouce carré", "kilomètre carré", "mètre carré", "mile carré", "yard carré", "pied carré"];
...
defaultUnits[0] = ["acre", "mile carré"];
...
property[2] = "Masse (Poids)";
unit[2] = ["tonne", "kilogramme", "gramme", "milligramme", "tonne [longue, UK]", "tonne [courte, US]", "centaine de poids [longue, UK]", "centaine de poids [courte, US]", "quart [UK]", "quart [US]", "slug", "stone", "livre", "livre troy", "once", "once troy", "Robie", "drame", "drachme", "point", "grain"];
...
defaultUnits[2] = ["kilogramme", "livre"];

property[3] = "Pression";
unit[3] = ["atmosphère", "bar", "mbar", "kgf/m2", "kgf/cm2", "kPa", "MPa", "Pa", "lbf/ft2", "psi", "torr", "ksi", "kilopascal [kPa]", "Pascal", "millimètre de mercure [0 °C]", "atmosphère [standard]", "atmosphère technique [at]", "Colonne d'eau [mètre]", "kilogramme-force par mètre carré", "dyne par centimètre carré", "gramme-force par centimètre carré", "kilogramme-force par centimètre carré", "kilogramme-force par millimètre carré", "kilopond par mètre carré", "millibar", "newton par mètre carré", "once par pouce carré", "livre par pied carré", "livre par pouce carré", "poundal par pied carré", "atmosphère technique", "tonne par mètre carré", "Colonne d'eau [centimètre]", "Colonne d'eau [pouce]", "Colonne d'eau [millimètre]"];
...
defaultUnits[3] = ["livre par pouce carré", "kilopascal [kPa]"];
...
property[5] = "Volume & Capacité";
unit[5] = ["mètre cube", "litre", "litre", "centilitre", "millilitre", "cc", "centimètre cube", "microlitre", "tasse [métrique]", "cuillère à soupe [métrique]", "cuillère à café [métrique]", "baril", "seau", "baril [Royaume-Uni]", "seau [Royaume-Uni]", "boisseau [Royaume-Uni]", "pied cube", "pouce cube", "mile cube", "tasse", "drame", "cinquième", "gallon [liquide]", "gallon [Royaume-Uni]", "gill [US]", "gill [Royaume-Uni]", "minim", "once", "once [Royaume-Uni, liquide]", "boisseau [Royaume-Uni]", "boisseau [US]", "pinte", "pinte [Royaume-Uni]", "quart", "Robie", "shot", "cuillère à soupe", "cuillère à café", "cuillère à soupe [Royaume-Uni]", "cuillère à café [Royaume-Uni]"];
...
defaultUnits[5] = ["litre", "once"];

property[6] = "Accélération";
unit[6] = ["mètre par seconde carrée", "pied par seconde carrée", "gravité (accélération)", "Galiléo", "pouce par seconde carrée"];
factor[6] = [1, 0.3048, 9.80665, 0.01, 0.0254];
defaultUnits[6] = ["mètre par seconde carrée", "pied par seconde carrée"];

property[7] = "Capacitance";
unit[7] = ["Faraday [F]", "millifaraday [mF]", "microfaraday [µF]", "nanofaraday [nF]", "picofaraday [pF]"];
factor[7] = [1, 1E-3, 1E-6, 1E-9, 1E-12];
defaultUnits[7] = ["microfaraday [µF]", "nanofaraday [nF]"];

property[8] = "Densité et Capacité de Masse";
unit[8] = ["gramme par centimètre cube","gramme par litre","gramme par millilitre","kilogramme par litre","kilogramme par mètre cube","tonne par mètre cube","milligramme par litre","milligramme par millilitre","once par pouce cube","once par gallon [UK]","once par gallon [US]","livre par pouce cube","livre par gallon [UK]","livre par gallon [US]"];
...
defaultUnits[8] = ["kilogramme par mètre cube","livre par gallon [US]"];

property[9] = "Charge Électrique";
unit[9] = ["Coulomb [C]", "abcoulomb", "Ampère-heure [A.hr]"];
factor[9] = [1, 10, 3600];
defaultUnits[9] = ["Coulomb [C]", "Ampère-heure [A.hr]"];

property[10] = "Énergie";
unit[10] = ["Btu","calorie (nutritionnelle)","calorie (thermochimique)","gallon (US) de GPL","cheval-vapeur-heure","Joule","kilogramme-force mètre","kilowatt-heure","tonne (explosif)","watt-heure"];
factor[10] = [1055.0559,4186.8,4.184,100757838.45,2684519.5,1,9.80665,3600000,4184000000,3600];
defaultUnits[10] = ["Joule","kilowatt-heure"];

property[11] = "Force";
unit[11] = ["Newton (N)", "Dyne (dy)", "Kilogramme-force (kgf)", "Kilopond (kpf)", "Kip (k)", "Once-force (ozf)", "Livres-force (lbf)", "Poundal"];
factor[11] = [1, 0.00001, 9.806650, 9.806650, 4448.222, 0.2780139, 4.4482216, 0.138255];
defaultUnits[11] = ["Kilogramme-force (kgf)", "Newton (N)"];

property[12] = "Force par Longueur";
unit[12] = ["Newton par mètre (N/m)", "livres-force par pouce (lbf/po)", "livres-force par pied (lbf/pied)"];
factor[12] = [1, 175.1268, 14.5939];
defaultUnits[12] = ["Newton par mètre (N/m)", "livres-force par pouce (lbf/po)"];

property[13] = "Éclairement";
unit[13] = ["lumen/m² (lu/m²)", "lumen/cm²", "lumen/pied²", "pied-bougie (ft-cdl)", "foot-lambert", "candela/m²", "candela/cm²", "lux (lx)", "nox (nx)", "phot (ph)"];
factor[13] = [1, 10000, 10.76391, 10.76391, 10.76391, 3.141592505, 31415.92505, 1, -328716, 10000];
defaultUnits[13] = ["lumen/m² (lu/m²)", "lumen/pied²"];

property[14] = "Débit Massique";
unit[14] = ["kilogramme par seconde (kg/s)", "livre de masse par seconde (lbm/s)", "livre de masse par minute (lbm/min)"];
factor[14] = [1, 0.4535924, 0.007559873];
defaultUnits[14] = ["kilogramme par seconde (kg/s)", "livre de masse par seconde (lbm/s)"];

property[15] = "Puissance";
unit[15] = ["Btu/heure", "calorie/heure", "gigawatt", "cheval-vapeur (électrique)", "cheval-vapeur (international)", "cheval-vapeur (métrique)", "cheval-vapeur (eau)", "kilocalorie/heure", "kilowatt", "mégawatt", "microwatt", "milliwatt", "tonne de réfrigération", "watt"];
...
defaultUnits[15] = ["cheval-vapeur (électrique)", "watt"];

property[16] = "Couple";
unit[16] = ["Newton-mètre (N.m)", "dyne-centimètre (dy.cm)", "kgf-mètre (kgf.m)", "lbf-pouce (lbf.po)", "lbf-pied (lbf.pied)"];
factor[16] = [1, 0.0000001, 9.806650, 0.1129848, 1.355818];
defaultUnits[16] = ["Newton-mètre (N.m)", "kgf-mètre (kgf.m)"];

property[17] = "Temps";
unit[17] = ["Seconde (sec)", "Jour (solaire moyen)", "Jour (sidéral)", "Heure (solaire moyen)", "Heure (sidéral)", "Minute (solaire moyen)", "Minute (sidéral)", "Mois (calendrier moyen)", "Seconde (sidéral)", "Année (calendrier)", "Année (tropicale)", "Année (sidérale)"];
factor[17] = [1, 8.640E4, 86164.09, 3600, 3590.17, 60, 60, 2628000, 0.9972696, 31536000, 31556930, 31558150];
defaultUnits[17] = ["Jour (solaire moyen)", "Seconde (sec)"];

property[18] = "Vitesse";
unit[18] = ["kilomètre par seconde", "kilomètre par heure", "centimètre par seconde", "mètre par seconde", "mètre par minute", "pied par seconde", "pied par minute", "pied par heure", "mile par heure", "mile par seconde", "mille marin par heure", "yard par seconde", "nœud", "mach", "vitesse de la lumière [air]", "vitesse de la lumière [vide]", "vitesse du son [air]"];
...
defaultUnits[18] = ["kilomètre par heure", "mile par heure"];

property[19] = "Viscosité";
unit[19] = ["Newton-seconde par mètre", "centipoise", "centistoke", "pied carré par seconde", "Poise", "poundal-seconde par pied carré", "livre-masse par pied-seconde", "livre-force-seconde par pied carré", "rhe", "slug par pied-seconde", "stoke"];
factor[19] = [1, 0.001, 0.000001, 9.290304E-02, 0.1, 1.488164, 1.488164, 47.88026, 10, 47.88026, 0.0001];
defaultUnits[19] = ["Newton-seconde par mètre", "poundal-seconde par pied carré"];

property[20] = "Débit volumique";
unit[20] = ["baril par minute [UK]", "baril par minute [US]", "centimètre cube par seconde", "pied cube par seconde", "mètre cube par seconde", "millimètre cube par seconde", "gallon par seconde [UK]", "gallon par seconde [US]", "litre par seconde", "millilitre par seconde"];
...
defaultUnits[20] = ["pied cube par minute", "mètre cube par seconde"];

property[21] = "Angle";
unit[21] = ["degré", "grade", "radian", "1/10 de cercle", "1/16 de cercle", "1/2 de cercle", "1/4 de cercle", "1/6 de cercle", "1/8 de cercle", "minute d'arc", "degré binaire", "radian binaire", "cycle", "angle complet", "grade [grad]", "mil", "minute d'arc milliésimale", "milliseconde d'arc", "minute", "octant", "point", "quart de cercle", "angle droit", "seconde", "sixième de cercle", "signe", "angle plat"];
...
function clearResults() {
	...
	document.getElementById("verbose").innerHTML = "<span class='destacado'>Veuillez choisir une grandeur physique, deux unités, puis entrez une valeur dans l'une des cases ci-dessus.</span>";
}
...
function explain(qTxt, from, to, converted) {
	...
	var ret = "";
	if (q == 0) { return ""; } // impossible de calculer le 'facteur'

	var factor = parseFloat((converted / q).toPrecision(14)); // parseFloat supprime les zéros à droite.
	// 14 est la longueur du nombre renvoyé par la fonction PHP dans le fichier xxxxx-unit-process.php
	var factorTxt = conversionFactorTxt(factor, 1E-8);
	var inv = 1 / factor;
	var invFact = roundDec(inv, 12);

	if (invFact % 1 === 0 && float2rat_p_error(invFact, 1E-8) === 0 && invFact > 0) { // vérifie si c'est un entier // invFact peut être nul si le 'facteur' est très grand ( > 10^12)

		ret += "<p><span class='destacado'>Formule :</span> divisez la valeur en " + pluralForConverters(from, 2) + " par " + invFact + " car 1 " + to + " équivaut à " + invFact + " " + pluralForConverters(from, 2) + ".</p>";

		ret += "<p>Donc, " + qTxt + " " + pluralForConverters(from, q) + " = <span class='fraction'><span class='top'>" + qTxt + "</span><span class='bottom'>" + invFact + "</span></span> = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? (" ou <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";

	} else {

		ret = "<p><span class='destacado'>Formule :</span> multipliez la valeur en " + pluralForConverters(from, 2) + " par le facteur de conversion '" + factorTxt + "'.</p>";

		ret += "<p>Donc, " + qTxt + " " + pluralForConverters(from, q) + " = " + qTxt + " × " + factorTxt + " = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? (" ou <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";
...
function expliquerTempérature(val, de, à) {
  var dec = 3;
  val *= 1;
  var tuple = de + "_" + à;

  if (de == à) {
    return "Veuillez choisir deux unités différentes.";
  }

  var comment = "<h3>Comment convertir " + val + " " + de + " en " + à + " ?<\/h3>";
  comment += "<p>Pour convertir de " + de + " en " + à + ", utilisez la formule : <\/p><p><span class=\"formule\">" + formuleTempérature(tuple) + "<\/span><\/p>";

  if (tuple == "Celsius_Fahrenheit") {
    //"Celsius Fahrenheit":q*9/5+32,
    comment += "<p>Ainsi, en multipliant la valeur '" + val + "' en " + de + " par 9, en divisant le résultat par 5, puis en ajoutant 32, nous obtenons:<\/p><p>";
    comment += val + " " + de + " = " + val + " × " + " 9⁄5 + 32 = " + roundDec(val * 9 / 5, dec) + " + 32 = " + roundDec(val * 9 / 5 + 32, dec) + " " + à + ".";
  } else if (tuple == "Celsius_Kelvin") {
    //"Celsius Kelvin":q+273.15,
    comment += "<p>Ainsi, en ajoutant 273.15 à la valeur '" + val + "' en " + de + ", nous obtenons <\/p><p>";
    comment += val + " " + de + " = " + val + " + 273.15 = " + roundDec(val + 273.15, dec) + " " + à + ".";
  } else if (tuple == "Kelvin_Celsius") {
    //"Kelvin Celsius":q-273.15,
    comment += "<p>Ainsi, en soustrayant 273.15 de la valeur '" + val + "' en " + de + ", nous obtenons <\/p><p>";
    comment += val + " " + de + " = " + val + " - 273.15 = " + roundDec(val - 273.15, dec) + " " + à + ".";
  } else if (tuple == "Kelvin_Fahrenheit") {
    //"Kelvin Fahrenheit":q*9/5-459.67,
    comment += "<p>Ainsi, en multipliant la valeur '" + val + "' en " + de + " par 9, en divisant le résultat par 5 et en soustrayant -459.67, nous obtenons<\/p><p>";
    comment += val + " " + de + " = " + val + " × " + " 9⁄5 - 459.67 = " + roundDec(val * 9 / 5, dec) + " - 459.67 = " + roundDec(val * 9 / 5 - 459.67, dec) + " " + à + ".";
  } else if (tuple == "Fahrenheit_Celsius") {
    //"Fahrenheit Celsius":(q-32)*5/9,
    comment += "<p>Ainsi, en soustrayant 32 de la valeur '" + val + "' en " + de + ", en multipliant le résultat par 5, et en divisant le résultat par 9, nous obtenons<\/p><p>";
    comment += val + " " + de + " = (" + val + " - 32) × 5⁄9 = (" + (val - 32) + ") × 5⁄9 = " + roundDec((val - 32) * 5 / 9, dec) + " " + à + ".";
  } else if (tuple == "Fahrenheit_Kelvin") {
    //"Fahrenheit Kelvin":(q+459.67)*5/9,
    comment += "<p>Ainsi, en ajoutant 459.67 à la valeur '" + val + "' en " + de + ", en multipliant le résultat par 5, et en divisant par 9, nous obtenons<\/p><p>";
    comment += val + " " + de + " = (" + val + " + 459.67) × 5⁄9 = (" + (val + 459.67) + ") × 5⁄9 = " + roundDec((val + 459.67) * 5 / 9, dec) + " " + à + ".";
  }
...
function usableFractionsVerbose(x, from, to, qTxt) {
	...
	ret = "<h3>" + qTxt + " " + pluralForConverters(from, q) + " comme une fraction utilisable ou un entier en " + pluralForConverters(to, 2) + " :</h3>" + near + "<p class='compact'>Ce sont des valeurs alternatives pour " + qTxt + " " + pluralForConverters(from, q) + " en " + pluralForConverters(to) + ". Elles sont représentées sous forme de fraction ou d'entier proche de la valeur exacte (<span class='fraction'><span class='top'>1</span><span class='bottom'>2</span></span>, <span class='fraction'><span 'top'>1</span><span class='bottom'>4</span></span>, <span class='fraction'><span class='top'>3</span><span class='bottom'>4</span></span>, etc.). L'erreur d'approximation, le cas échéant, est à droite de la valeur.</p>";
