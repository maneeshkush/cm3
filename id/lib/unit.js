...
property[0] = "Luas";
unit[0] = ["ekar","are","hektar","sentimeter persegi","kaki persegi","inci persegi","kilometer persegi","meter persegi","mil persegi","yard persegi","kaki persegi"];
...
defaultUnits[0] = ["ekar", "mil persegi"];
...
property[2] = "Massa (Berat)";
unit[2] = ["ton","kilogram","gram","miligram","ton [panjang, UK]","ton [pendek, US]","kuintal [panjang, UK]","kuintal [pendek, US]","kuarter [UK]","kuarter [US]","slug","batu","pound","troy pound","ons","troy ons","Robie","dram","drachme","titik","butir"];
...
property[3] = "Tekanan";
unit[3] = ["atm","bar","mbar","kgf/m2","kgf/cm2","kPa","MPa","Pa","lbf/ft2","psi","torr","ksi","kilopascal [kPa]","Pascal","milimeter raksa [0 °C]","atmosfer [standar]","atmosfer teknis [at]","Kolom Air [meter]","kilogram-kekuatan per meter persegi","dyne per sentimeter persegi","gram-kekuatan per sentimeter persegi","kilogram-kekuatan per sentimeter persegi","kilogram-kekuatan per milimeter persegi","kilopond per meter persegi","milibar","newton per meter persegi","ons per inci persegi","pound per kaki persegi","pound per inci persegi","poundal per kaki persegi","atmosfer teknis","ton per meter persegi","Kolom Air [sentimeter]","Kolom Air [inci]","Kolom Air [milimeter]"];
...
property[5] = "Volume & Kapasitas";
unit[5] = ["meter kubik", "liter", "liter", "sentiliter", "mililiter", "cc", "sentimeter kubik", "mikroliter", "cup [metrik]", "sendok makan [metrik]", "sendok teh [metrik]", "barrel", "ember", "barrel [UK]", "ember [UK]", "bushel [UK]", "kaki kubik", "inci kubik", "mil kubik", "cup", "dram", "fifth", "gallon [cairan]", "gallon [UK]", "gill [US]", "gill [UK]", "minim", "ons", "ons [UK, cairan]", "peck [UK]", "peck [US]", "pint", "pint [UK]", "kuart", "Robie", "tembakan", "sendok makan", "sendok teh", "sendok makan [UK]", "sendok teh [UK]"];
...
defaultUnits[5] = ["liter", "ons"];

property[6] = "Percepatan";
unit[6] = ["meter per detik kuadrat", "kaki per detik kuadrat", "gravitasi (percepatan)", "Galileo", "inci per detik kuadrat"];
factor[6] = [1, 0.3048, 9.80665, 0.01, 0.0254];
defaultUnits[6] = ["meter per detik kuadrat", "kaki per detik kuadrat"];

property[7] = "Kapasitansi";
unit[7] = ["Faraday [F]", "milifaraday [mF]", "mikrofaraday [µF]", "manofaraday [nF]", "picofaraday [pF]"];
factor[7] = [1, 1E-3, 1E-6, 1E-9, 1E-12];
defaultUnits[7] = ["mikrofaraday [µF]", "nanofaraday [nF]"];

property[8] = "Massa Jenis & Kapasitas Massa";
unit[8] = ["gram per sentimeter kubik", "gram per liter", "gram per mililiter", "kilogram per liter", "kilogram per meter kubik", "ton per meter kubik", "miligram per liter", "miligram per mililiter", "ons per inci kubik", "ons per gallon [UK]", "ons per gallon [US]", "pound per inci kubik", "pound per gallon [UK]", "pound per gallon [US]"];
...
defaultUnits[8] = ["kilogram per meter kubik", "pound per gallon [US]"];

property[9] = "Muatan Listrik";
unit[9] = ["Coulomb [C]", "abcoulomb", "Ampere jam [A.jam]"];
factor[9] = [1, 10, 3600];
defaultUnits[9] = ["Coulomb [C]", "Ampere jam [A.jam]"];

property[10] = "Energi";
unit[10] = ["Btu", "kalori (nutrisi)", "kalori (termokimia)", "gallon (AS) LPG", "tenaga kuda-jam", "Joule", "kilogram-force meter", "kilowatt-jam", "ton (eksplosif)", "watt-jam"];
factor[10] = [1055.0559, 4186.8, 4.184, 100757838.45, 2684519.5, 1, 9.80665, 3600000, 4184000000, 3600];
defaultUnits[10] = ["Joule", "kilowatt-jam"];

property[11] = "Gayapaksa";
unit[11] = ["Newton (N)", "Dyne (dy)", "Kilogram gaya (kgf)", "Kilopond (kpf)", "Kip (k)", "Ounce force (ozf)", "Pound force (lbf)", "Poundal"];
factor[11] = [1, 0.00001, 9.806650, 9.806650, 4448.222, 0.2780139, 4.4482216, 0.138255];
defaultUnits[11] = ["Kilogram gaya (kgf)", "Newton (N)"];

property[12] = "Gayapaksa / Panjang";
...
property[13] = "Iluminansi";
unit[13] = ["lumen/m² (lu/m²)", "lumen/cm²", "lumen/kaki persegi", "foot-candle (ft-cdl)", "foot-lambert", "candela/m²", "candela/cm²", "lux (lx)", "nox (nx)", "phot (ph)"];
factor[13] = [1, 10000, 10.76391, 10.76391, 10.76391, 3.141592505, 31415.92505, 1, -328716, 10000];
defaultUnits[13] = ["lumen/m² (lu/m²)", "lumen/kaki persegi"];

property[14] = "Aliran Massa";
unit[14] = ["kilogram per detik (kg/s)", "pound massa per detik (lbm/s)", "pound massa per menit (lbm/min)"];
factor[14] = [1, 0.4535924, 0.007559873];
defaultUnits[14] = ["kilogram per detik (kg/s)", "pound massa per detik (lbm/s)"];

property[15] = "Daya";
unit[15] = ["Btu/jam", "kalori/jam", "gigawatt", "daya kuda (listrik)", "daya kuda (internasional)", "daya kuda (metrik)", "daya kuda (air)", "kilokalori/jam", "kilowatt", "megawatt", "mikrowatt", "milowatt", "ton pendingin", "watt"];
...
defaultUnits[15] = ["daya kuda (listrik)", "watt"];

property[16] = "Torsi";
unit[16] = ["Newton-meter (N.m)", "dyne-sentimeter(dy.cm)", "kgf-meter (kgf.m)", "lbf-inch (lbf.in)", "lbf-kaki (lbf.ft)"];
factor[16] = [1, 0.0000001, 9.806650, 0.1129848, 1.355818];
defaultUnits[16] = ["Newton-meter (N.m)", "kgf-meter (kgf.m)"];

property[17] = "Waktu";
unit[17] = ["Detik (sec)", "Hari (rata-rata surya)", "Hari (bintang)", "Jam (rata-rata surya)", "Jam (bintang)", "Menit (rata-rata surya)", "Menit (bintang)", "Bulan (kalender rata-rata)", "Detik (bintang)", "Tahun (kalender)", "Tahun (tropis)", "Tahun (bintang)"];
factor[17] = [1, 8.640E4, 86164.09, 3600, 3590.17, 60, 60, 2628000, 0.9972696, 31536000, 31556930, 31558150];
defaultUnits[17] = ["Hari (rata-rata surya)","Detik (sec)"];

property[18] = "Kecepatan & Speed";
unit[18] = ["kilometer per detik","kilometer per jam","sentimeter per detik","meter per detik","meter per menit","kaki per detik","kaki per menit","kaki per jam","mil per jam","mil per detik","mil laut per jam","yard per detik","knot","mach","kecepatan cahaya [udara]","kecepatan cahaya [vakum]","kecepatan suara [udara]"];
...
defaultUnits[18] = ["kilometer per jam","mil per jam"];

property[19] = "Viskositas";
unit[19] = ["Newton-detik per meter","centipoise","centistoke","kaki persegi per detik","Poise","poundal-detik per kaki persegi","pound massa per kaki-detik","pound kekuatan-detik per kaki persegi","rhe","slug per kaki-detik","stoke"];
factor[19] = [1, 0.001, 0.000001, 9.290304E-02, 0.1, 1.488164, 1.488164, 47.88026, 10, 47.88026, 0.0001];
defaultUnits[19] = ["Newton-detik per meter","poundal-detik per kaki persegi"];

property[20] = "Aliran Volume";
unit[20] = ["barrel per menit [UK]", "barrel per menit [US]", "sentimeter kubik per detik", "kaki kubik per detik", "meter kubik per detik", "milimeter kubik per detik", "gallon per detik [UK]", "gallon per detik [US]", "liter per detik", "mililiter per detik"];
...
defaultUnits[20] = ["kaki kubik per menit", "meter kubik per detik"];

property[21] = "Sudut";
unit[21] = ["derajat", "gradian", "radian", "1/10 lingkaran", "1/16 lingkaran", "1/2 lingkaran", "1/4 lingkaran", "1/6 lingkaran", "1/8 lingkaran", "menit busur", "derajat biner", "radian biner", "siklus", "sudut penuh", "gradian [grad]", "mil", "milimenit busur", "milidetik busur", "menit", "oktan", "titik", "kuadrant", "sudut kanan", "detik", "seksan", "tanda", "sudut lurus"];
...
defaultUnits[21] = ["radian", "derajat"];
...
function clearResults() {
	...
	document.getElementById("verbose").innerHTML = "<span class='destacado'>Silakan, pilih jenis besaran fisik, dua unit, lalu masukkan nilai ke salah satu kotak di atas.</span>";
}
...
function explain(qTxt, from, to, converted) {
	...
	var ret = "";
	if(q==0){return "";} // tidak dapat menghitung 'faktor'
	
	var factor = parseFloat((converted / q).toPrecision(14)); // parseFloat menghapus nol di sebelah kanan.
	// 14 adalah panjang angka yang dikembalikan oleh fungsi PHP di file xxxxx-unit-process.php
	var factorTxt = conversionFactorTxt(factor, 1E-8);
	var inv = 1 / factor;
	var invFact = roundDec(inv, 12); 

	if (invFact % 1 === 0 && float2rat_p_error(invFact, 1E-8) === 0 && invFact > 0) { // memeriksa apakah bilangan bulat // invFact bisa nol jika 'faktor' terlalu besar ( > 10^12)

		ret += "<p><span class='destacado'>Formula:</span> bagi nilai dalam " + pluralForConverters(from, 2) + " dengan " + invFact + " karena 1 " + to + " sama dengan " + invFact + " " + pluralForConverters(from, 2) + ".</p>";

		ret += "<p>Jadi, " + qTxt + " " + pluralForConverters(from, q) + " = <span class='fraction'><span class='top'>" + qTxt + "</span><span class='bottom'>" + invFact + "</span></span> = <span class='destacado'>" + bestFmt(converted,14) + "</span> " + (bestFmt(converted,14) != converted ? (" atau <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";

	} else {

		ret = "<p><span class='destacado'>Formula:</span> kalikan nilai dalam " + pluralForConverters(from, 2) + " dengan faktor konversi '" + factorTxt + "'.</p>";

		ret += "<p>Jadi, " + qTxt + " " + pluralForConverters(from, q) + " = " + qTxt + " × " + factorTxt + " = <span class='destacado'>" + bestFmt(converted,14) + "</span> " + (bestFmt(converted,14) != converted ? (" atau <span class 'destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";
...
function explainTemperature(val, from, to) {
  ...
  if (from === to) {
    return "Harap pilih dua unit yang berbeda.";
  }

  var how = "<h3>Cara mengkonversi " + val + " " + from + " ke " + to + "?<\/h3>";
  how += "<p>Untuk mengkonversi dari " + from + " ke " + to + ", gunakan rumus berikut: <\/p><p><span class=\"formula\">" + temperatureFormula(tuple) + "<\/span><\/p>";

  if (tuple === "Celsius_Fahrenheit") {
    //"Celsius Fahrenheit":q*9/5+32,
    how += "<p>Dengan demikian, mengalikan nilai '" + val + "' dalam " + from + " dengan 9, membagi hasilnya dengan 5, kemudian menambahkan 32, kita dapatkan:<\/p><p>";
    ...
    how += "<p>Dengan demikian, menambahkan 273.15 ke nilai '" + val + "' dalam " + from + ", kita dapatkan <\/p><p>";
    how += val + " " + from + " = " + val + " + 273.15 = " + roundDec(val + 273.15, dec) + " " + to + ".";
  } else if (tuple === "Kelvin_Celsius") {
    //"Kelvin Celsius":q-273.15,
    how += "<p>Dengan demikian, mengurangkan 273.15 dari nilai '" + val + "' dalam " + from + ", kita dapatkan <\/p><p>";
    how += val + " " + from + " = " + val + " - 273.15 = " + roundDec(val - 273.15, dec) + " " + to + ".";
  } else if (tuple === "Kelvin_Fahrenheit") {
    //"Kelvin Fahrenheit":q*9/5-459.67,
    how += "<p>Dengan demikian, mengalikan nilai '" + val + "' dalam " + from + " dengan 9, membagi hasilnya dengan 5, dan mengurangkan -459.67, kita dapatkan<\/p><p>";
    ...
    how += "<p>Dengan demikian, mengurangkan 32 dari nilai '" + val + "' dalam " + from + ", mengalikan hasilnya dengan 5, dan membagi hasilnya dengan 9, kita dapatkan<\/p><p>";
    ...
    how += "<p>Dengan demikian, menambahkan 459.67 ke nilai '" + val + "' dalam " + from + ", mengalikan hasilnya dengan 5, dan membagi hasilnya dengan 9, kita dapatkan<\/p><p>";
...
function usableFractionsVerbose(x, from, to, qTxt) {
	...
	ret = "<h3>" + qTxt + " " + pluralForConverters(from, q) + " sebagai pecahan yang dapat digunakan atau bilangan bulat dalam " + pluralForConverters(to, 2) + ":</h3>" + near + "<p class='compact'>Ini adalah nilai alternatif untuk " + qTxt + " " + pluralForConverters(from, q) + " dalam " + pluralForConverters(to) + ". Mereka direpresentasikan sebagai pecahan atau bilangan bulat yang mendekati nilai yang tepat (<span class='fraction'><span class='top'>1</span><span class='bottom'>2</span></span>, <span class='fraction'><span class='top'>1</span><span class='bottom'>4</span></span>, <span class='fraction'><span class='top'>3</span><span class='bottom'>4</span></span>, dll.). Kesalahan aproksimasi, jika ada, ada di sebelah kanan nilai.</p>";
