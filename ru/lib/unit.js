...
property[0] = "Площадь";
unit[0] = ["акр", "ар", "гектар", "квадратный сантиметр", "квадратный фут", "квадратный дюйм", "квадратный километр", "квадратный метр", "квадратная миля", "квадратный ярд", "квадратные футы"];
...
defaultUnits[0] = ["акр", "квадратная миля"];
...
property[2] = "Масса (Вес)";
unit[2] = ["тонна","килограмм","грамм","миллиграмм","тонна [длинная, Великобритания]","тонна [краткая, США]","центнер [длинный, Великобритания]","центнер [краткий, США]","четверть [Великобритания]","четверть [США]","слаг","стоун","фунт","тройский фунт","унция","тройская унция","Роби","драм","драхма","пункт","гран"];
...
defaultUnits[2] = ["килограмм", "фунт"];

property[3] = "Давление";
unit[3] = ["атмосфера","бар","миллибар","кгс/м2","кгс/см2","кПа","МПа","Па","фунт/фут2","psi","торр","ksi","килопаскаль [кПа]","Паскаль","миллиметр ртути [0 °C]","стандартная атмосфера","техническая атмосфера [ат]","водяной столб [метр]","кгс/м2","дин/см2","гф/см2","кгс/см2","кгс/мм2","кгп/м2","миллибар","ньютон/м2","унция/дюйм2","фунт/фут2","фунт/дюйм2","фунтал/фут2","техническая атмосфера","тонна/м2","водяной столб [сантиметр]","водяной столб [дюйм]","водяной столб [миллиметр]"];
...
defaultUnits[3] = ["фунт/дюйм2", "килопаскаль [кПа]"];
...
property[5] = "Объем и Емкость";
unit[5] = ["кубический метр", "литр", "литр", "сантиметр", "миллилитр", "кубический сантиметр", "микролитр", "чашка [метрическая]", "столовая ложка [метрическая]", "чайная ложка [метрическая]", "баррель", "ведро", "баррель [Великобритания]", "ведро [Великобритания]", "бушель [Великобритания]", "кубический фут", "кубический дюйм", "кубическая миля", "чашка", "дрэм", "пятая часть", "галлон [жидкий]", "галлон [Великобритания]", "гил [США]", "гил [Великобритания]", "миним", "унция", "унция [Великобритания, жидкая]", "пек [Великобритания]", "пек [США]", "пинта", "пинта [Великобритания]", "кварта", "Роби", "выстрел", "столовая ложка", "чайная ложка", "столовая ложка [Великобритания]", "чайная ложка [Великобритания]"];
...
defaultUnits[5] = ["литр", "унция"];

property[6] = "Ускорение";
unit[6] = ["метр в секунду в квадрате", "фут в секунду в квадрате", "гравитация (ускорение)", "Галилео", "дюйм в секунду в квадрате"];
factor[6] = [1, 0.3048, 9.80665, 0.01, 0.0254];
defaultUnits[6] = ["метр в секунду в квадрате", "фут в секунду в квадрате"];

property[7] = "Емкость";
unit[7] = ["Фарадей [Ф]", "миллифарадей [мФ]", "микрофарадей [µФ]", "манофарадей [нФ]", "пикофарадей [пФ]"];
factor[7] = [1, 1E-3, 1E-6, 1E-9, 1E-12];
defaultUnits[7] = ["микрофарадей [µФ]", "нанофарадей [нФ]"];

property[8] = "Плотность и Массовая емкость";
unit[8] = ["грамм на кубический сантиметр", "грамм на литр", "грамм на миллилитр", "килограмм на литр", "килограмм на кубический метр", "тонна на кубический метр", "миллиграмм на литр", "миллиграмм на миллилитр", "унция на кубический дюйм", "унция на галлон [Великобритания]", "унция на галлон [США]", "фунт на кубический дюйм", "фунт на галлон [Великобритания]", "фунт на галлон [США]"];
...
defaultUnits[8] = ["килограмм на кубический метр", "фунт на галлон [США]"];

property[9] = "Электрический Заряд";
unit[9] = ["Кулон [Кл]", "Ампер-час [А.ч.]"];
factor[9] = [1, 3600];
defaultUnits[9] = ["Кулон [Кл]", "Ампер-час [А.ч.]"];

property[10] = "Энергия";
unit[10] = ["Британская термическая единица [Btu]", "Калория (пищевая)", "Калория (термохимическая)", "Галлон (США) сжиженного газа", "Лошадинчас механической работы", "Джоуль [Дж]", "Килограмм-сила-метр [кгс м]", "Киловатт-час [кВтч]", "Тонна тротила", "Ватт-час [Втч]"];
factor[10] = [1055.0559, 4186.8, 4.184, 100757838.45, 2684519.5, 1, 9.80665, 3600000, 4184000000, 3600];
defaultUnits[10] = ["Джоуль [Дж]", "Киловатт-час [кВтч]"];

property[11] = "Сила";
unit[11] = ["Ньютон [Н]", "Дин [дн]", "Килограмм-сила [кгс]", "Килопонд [кп]", "Кип [к]", "Унция-сила [унц]", "Фунт-сила [фунт]", "Фундаль"];
factor[11] = [1, 0.00001, 9.806650, 9.806650, 4448.222, 0.2780139, 4.4482216, 0.138255];
defaultUnits[11] = ["Килограмм-сила [кгс]", "Ньютон [Н]"];

property[12] = "Сила / Длина";
unit[12] = ["Ньютон на метр [Н/м]", "Фунт-сила на дюйм [фунт-сила/дюйм]", "Фунт-сила на фут [фунт-сила/фут]"];
factor[12] = [1, 175.1268, 14.5939];
defaultUnits[12] = ["Ньютон на метр [Н/м]", "Фунт-сила на дюйм [фунт-сила/дюйм]"];

property[13] = "Освещенность";
unit[13] = ["люмен/м² (лм/м²)","люмен/см²","люмен/фут²","фут-свеча (фт-св)","фут-ламберт","кандела/м²","кандела/см²","люкс (лк)","нокс (нкс)","фот (фот)"];
factor[13] = [1,10000,10.76391,10.76391,10.76391,3.141592505,31415.92505,1,-328716,10000];
defaultUnits[13] = ["люмен/м² (лм/м²)","люмен/фут²"];

property[14] = "Массовый поток";
unit[14] = ["килограмм в секунду (кг/с)","фунт массы в секунду (фунт/с)","фунт массы в минуту (фунт/мин)",];
factor[14] = [1, 0.4535924, 0.007559873];
defaultUnits[14] = ["килограмм в секунду (кг/с)", "фунт массы в секунду (фунт/с)"];

property[15] = "Мощность";
unit[15] = ["Британская термическая единица в час (BTU/час)","калория в час (кал/час)","гигаватт","лошадиная сила (электрическая)","лошадиная сила (международная)","лошадиная сила (метрическая)","лошадиная сила (водяная)","килокалория в час","киловатт","мегаватт","микроватт","милливатт","тонна охлаждения","ватт"];
...
defaultUnits[15] = ["лошадиная сила (электрическая)","ватт"];

property[16] = "Крутящий момент";
unit[16] = ["Ньютон-метр (Н·м)","дин-сантиметр(дин·см)","кгс-метр (кгс·м)","фунт-фут (фунт·фут)","фунт-дюйм (фунт·дюйм)"];
factor[16] = [1, 0.0000001, 9.806650, 0.1129848, 1.355818];
defaultUnits[16] = ["Ньютон-метр (Н·м)","кгс-метр (кгс·м)"];

property[17] = "Время";
unit[17] = ["Секунда (сек)", "Сутки (среднесолнечные)", "Сутки (звездные)", "Час (среднесолнечные)", "Час (звездные)", "Минута (среднесолнечные)", "Минута (звездные)", "Месяц (средний календарь)", "Секунда (звездная)", "Год (календарь)", "Год (тропический)", "Год (звездный)"];
factor[17] = [1, 8.640E4, 86164.09, 3600, 3590.17, 60, 60, 2628000, 0.9972696, 31536000, 31556930, 31558150];
defaultUnits[17] = ["Сутки (среднесолнечные)","Секунда (сек)"];

property[18] = "Скорость";
unit[18] = ["километр в секунду","километр в час","сантиметр в секунду","метр в секунду","метр в минуту","фут в секунду","фут в минуту","фут в час","миля в час","миля в секунду","морская миля в час","ярд в секунду","узел","мах","скорость света [воздух]","скорость света [вакуум]","скорость звука [воздух]"];
...
defaultUnits[18] = ["километр в час","миля в час"];

property[19] = "Вязкость";
unit[19] = ["Ньютон-секунда на метр","сантипойз","сантисток","квадратный фут в секунду","Пойз","фундаль-секунда на квадратный фут","фунт массы на фут-секунду","фунт-сила-секунда на квадратный фут","ре","слаг на фут-секунду","сток"];
factor[19] = [1, 0.001, 0.000001, 9.290304E-02, 0.1, 1.488164, 1.488164, 47.88026, 10, 47.88026, 0.0001];
defaultUnits[19] = ["Ньютон-секунда на метр","фундаль-секунда на квадратный фут"];

property[20] = "Расход объема";
unit[20] = ["баррель в минуту [Великобритания]","баррель в минуту [США]","кубический сантиметр в секунду","кубический фут в секунду","кубический метр в секунду","кубический миллиметр в секунду","галлон в секунду [Великобритания]","галлон в секунду [США]","литр в секунду","миллилитр в секунду"];
...
defaultUnits[20] = ["кубический фут в минуту","кубический метр в секунду"];

property[21] = "Угол";
unit[21] = ["градус","град","радиан","1/10 круга","1/16 круга","1/2 круга","1/4 круга","1/6 круга","1/8 круга","угловая минута","бинарный градус","бинарный радиан","цикл","полный угол","градиан [град]","мил","миллиугловая минута","миллисекунда дуги","минута","октант","пункт","квадрант","прямой угол","секунда","секстант","знак","полный угол"];
...
function clearResults() {
	...
	document.getElementById("verbose").innerHTML = "<span class='destacado'>Пожалуйста, выберите физическую величину, две единицы измерения и затем введите значение в одно из полей выше.</span>";
}
...
function explain(qTxt, from, to, converted) {
    ...
    if (q == 0) {
        return "";
    } // не удается вычислить 'фактор'

    var factor = parseFloat((converted / q).toPrecision(14)); // parseFloat удаляет нули справа.
    // 14 - это длина числа, возвращаемого функцией PHP в файле xxxxx-unit-process.php
    var factorTxt = conversionFactorTxt(factor, 1E-8);
    var inv = 1 / factor;
    var invFact = roundDec(inv, 12);

    if (invFact % 1 === 0 && float2rat_p_error(invFact, 1E-8) === 0 && invFact > 0) { // проверяет, является ли целым числом
        ret += "<p><span class='destacado'>Формула:</span> разделите значение в " + pluralForConverters(from, 2) + " на " + invFact + ", потому что 1 " + to + " равно " + invFact + " " + pluralForConverters(from, 2) + ".</p>";

        ret += "<p>Итак, " + qTxt + " " + pluralForConverters(from, q) + " = <span class='fraction'><span class='top'>" + qTxt + "</span><span class='bottom'>" + invFact + "</span></span> = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? (" или <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";

    } else {
        ret = "<p><span class='destacado'>Формула:</span> умножьте значение в " + pluralForConverters(from, 2) + " на коэффициент преобразования '" + factorTxt + "'.</p>";

        ret += "<p>Итак, " + qTxt + " " + pluralForConverters(from, q) + " = " + qTxt + " × " + factorTxt + " = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? (" или <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";
    }
...
function explainTemperature(val, from, to) {
  ...
  if (from == to) {
    return "Пожалуйста, выберите две разные единицы измерения.";
  }

  var how = "<h3>Как конвертировать " + val + " " + from + " в " + to + "?<\/h3>";
  how += "<p>Для преобразования из " + from + " в " + to + " используйте формулу: <\/p><p><span class=\"formula\">" + temperatureFormula(tuple) + "<\/span><\/p>";

  if (tuple == "Celsius_Fahrenheit") {
    //"Celsius Fahrenheit":q*9/5+32,
    how += "<p>Таким образом, умножив значение '" + val + "' в " + from + " на 9, разделив результат на 5, а затем добавив 32, мы получим:<\/p><p>";
    ...
    how += "<p>Таким образом, добавив 273.15 к значению '" + val + "' в " + from + ", мы получим <\/p><p>";
    how += val + " " + from + " = " + val + " + 273.15 = " + roundDec(val + 273.15, dec) + " " + to + ".";
  } else if (tuple == "Kelvin_Celsius") {
    //"Kelvin Celsius":q-273.15,
    how += "<p>Таким образом, вычтя 273.15 из значения '" + val + "' в " + from + ", мы получим <\/p><p>";
    how += val + " " + from + " = " + val + " - 273.15 = " + roundDec(val - 273.15, dec) + " " + to + ".";
  } else if (tuple == "Kelvin_Fahrenheit") {
    //"Kelvin Fahrenheit":q*9/5-459.67,
    how += "<p>Таким образом, умножив значение '" + val + "' в " + from + " на 9, разделив результат на 5 и вычтя -459.67, мы получим<\/p><p>";
    ...
    how += "<p>Таким образом, вычтя 32 из значения '" + val + "' в " + from + ", умножив результат на 5 и разделив на 9, мы получим<\/p><p>";
    ...
    how += "<p>Таким образом, добавив 459.67 к значению '" + val + "' в " + from + ", умножив результат на 5 и разделив на 9, мы получим<\/p><p>";
...
function usableFractionsVerbose(x, from, to, qTxt) {
	...
	ret = "<h3>" + qTxt + " " + pluralForConverters(from, q) + " как используемая дробь или целое число в " + pluralForConverters(to, 2) + ":</h3>" + near + "<p class='compact'>Это альтернативные значения для " + qTxt + " " + pluralForConverters(from, q) + " в " + pluralForConverters(to) + ". Они представлены в виде дроби или целого числа, близкого к точному значению (<span class='fraction'><span class='top'>1</span><span class='bottom'>2</span></span>, <span class='fraction'><span class='top'>1</span><span class='bottom'>4</span></span>, <span class='fraction'><span class='top'>3</span><span class='bottom'>4</span></span> и т. д.). Приближенная ошибка, если она есть, указана справа от значения.</p>";
