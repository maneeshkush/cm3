...
property[0] = "Área";
unit[0] = ["acre", "área", "hectare", "centímetro quadrado", "pé quadrado", "polegada quadrada", "quilômetro quadrado", "metro quadrado", "milha quadrada", "jarda quadrada", "pés quadrados"];
...
defaultUnits[0] = ["acre", "milha quadrada"];
...
unit[2] = ["tonelada", "quilograma", "grama", "miligrama", "ton [longa, Reino Unido]", "tonelada [curta, EUA]", "quintal [longo, Reino Unido]", "quintal [curto, EUA]", "quarto [Reino Unido]", "quarto [EUA]", "slug", "stone", "libra", "libra troy", "onça", "onça troy", "Robie", "dracma", "dram", "ponto", "grão"];
...
defaultUnits[2] = ["quilograma", "libra"];

property[3] = "Pressão";
unit[3] = ["atm", "bar", "mbar", "kgf/m2", "kgf/cm2", "kPa", "MPa", "Pa", "lbf/ft2", "psi", "torr", "ksi", "quilopascal [kPa]", "Pascal", "milímetro de mercúrio [0 °C]", "atmosfera [padrão]", "atmosfera técnica [at]", "Coluna d'água [metro]", "quilograma-força por metro quadrado", "dyne por centímetro quadrado", "grama-força por centímetro quadrado", "quilograma-força por centímetro quadrado", "quilograma-força por milímetro quadrado", "quilopond por metro quadrado", "milibar", "newton por metro quadrado", "onça por polegada quadrada", "libra por pé quadrado", "libra por polegada quadrada", "poundal por pé quadrado", "atmosfera técnica", "tonelada por metro quadrado", "Coluna d'água [centímetro]", "Coluna d'água [polegada]", "Coluna d'água [milímetro]"];
...
defaultUnits[3] = ["libra por polegada quadrada", "quilopascal [kPa]"];
...
property[5] = "Volume e Capacidade";
unit[5] = ["metro cúbico", "litro", "litro", "centilitro", "mililitro", "cc", "centímetro cúbico", "microlitro", "xícara [métrica]", "Colher de sopa [métrica]", "Colher de chá [métrica]", "barril", "balde", "barril [Reino Unido]", "balde [Reino Unido]", "alqueire [Reino Unido]", "pé cúbico", "polegada cúbica", "milha cúbica", "xícara", "dracma", "quinta", "galão [líquido]", "galão [Reino Unido]", "gill [EUA]", "gill [Reino Unido]", "minim", "onça", "onça [Reino Unido, líquido]", "peck [Reino Unido]", "peck [EUA]", "pinta", "Robie", "shot", "Colher de sopa", "Colher de chá", "Colher de sopa [Reino Unido]", "Colher de chá [Reino Unido]"];
...
defaultUnits[5] = ["litro", "onça"];

property[6] = "Aceleração";
unit[6] = ["metro por segundo quadrado", "pé por segundo quadrado", "gravidade (aceleração)", "Galileu", "polegada por segundo quadrado"];
factor[6] = [1, 0.3048, 9.80665, 0.01, 0.0254];
defaultUnits[6] = ["metro por segundo quadrado", "pé por segundo quadrado"];

property[7] = "Capacitância";
unit[7] = ["Faraday [F]", "milifaraday [mF]", "microfaraday [µF]", "manofaraday [nF]", "picofaraday [pF]"];
factor[7] = [1, 1E-3, 1E-6, 1E-9, 1E-12];
defaultUnits[7] = ["microfaraday [µF]", "nanofaraday [nF]"];

property[8] = "Densidade e Capacidade de Massa";
unit[8] = ["grama por centímetro cúbico", "grama por litro", "grama por mililitro", "quilograma por litro", "quilograma por metro cúbico", "tonelada por metro cúbico", "miligrama por litro", "miligrama por mililitro", "onça por polegada cúbica", "onça por galão [Reino Unido]", "onça por galão [EUA]", "libra por polegada cúbica", "libra por galão [Reino Unido]", "libra por galão [EUA]"];
...
defaultUnits[8] = ["quilograma por metro cúbico", "libra por galão [EUA]"];

property[9] = "Carga Elétrica";
unit[9] = ["Coulomb [C]", "abcoulomb", "Ampere hora [A.hr]"];
factor[9] = [1, 10, 3600];
defaultUnits[9] = ["Coulomb [C]", "Ampere hora [A.hr]"];

property[10] = "Energia";
unit[10] = ["Btu", "caloria (nutricional)", "caloria (termoquímica)", "galão (EUA) de GLP", "cavalo-vapor-hora", "Joule", "quilograma-força metro", "quilowatt-hora", "tonelada (explosiva)", "watt-hora"];
factor[10] = [1055.0559, 4186.8, 4.184, 100757838.45, 2684519.5, 1, 9.80665, 3600000, 4184000000, 3600];
defaultUnits[10] = ["Joule", "quilowatt-hora"];

property[11] = "Força";
unit[11] = ["Newton (N)", "Dina (dy)", "Quilograma-força (kgf)", "Quilopond (kpf)", "Kip (k)", "Onça-força (ozf)", "Libra-força (lbf)", "Poundal"];
factor[11] = [1, 0.00001, 9.806650, 9.806650, 4448.222, 0.2780139, 4.4482216, 0.138255];
defaultUnits[11] = ["Quilograma-força (kgf)", "Newton (N)"];

property[12] = "Força / Comprimento";
unit[12] = ["Newton por metro (N/m)", "libra-força por polegada (lbf/in)", "libra-força por pé (lbf/ft)"];
factor[12] = [1, 175.1268, 14.5939];
defaultUnits[12] = ["Newton por metro (N/m)", "libra-força por polegada (lbf/in)"];

property[13] = "Iluminância";
...
property[14] = "Fluxo de Massa";
unit[14] = ["quilograma por segundo (kg/s)", "libra massa por segundo (lbm/s)", "libra massa por minuto (lbm/min)"];
factor[14] = [1, 0.4535924, 0.007559873];
defaultUnits[14] = ["quilograma por segundo (kg/s)", "libra massa por segundo (lbm/s)"];

property[15] = "Potência";
unit[15] = ["Btu/hora", "caloria/hora", "gigawatt", "cavalo-vapor (elétrico)", "cavalo-vapor (internacional)", "cavalo-vapor (métrico)", "cavalo-vapor (água)", "quilocaloria/hora", "quilowatt", "megawatt", "microwatt", "milliwatt", "tonelada de refrigeração", "watt"];
...
defaultUnits[15] = ["cavalo-vapor (elétrico)", "watt"];

property[16] = "Torque";
unit[16] = ["Newton-metro (N.m)", "dyne-centímetro(dy.cm)", "kgf-metro (kgf.m)", "lbf-inch (lbf.in)", "lbf-foot (lbf.ft)"];
factor[16] = [1, 0.0000001, 9.806650, 0.1129848, 1.355818];
defaultUnits[16] = ["Newton-metro (N.m)", "kgf-metro (kgf.m)"];

property[17] = "Tempo";
unit[17] = ["Segundo (s)", "Dia (médio solar)", "Dia (sidéreo)", "Hora (média solar)", "Hora (sidérea)", "Minuto (médio solar)", "Minuto (sidéreo)", "Mês (calendário médio)", "Segundo (sidéreo)", "Ano (calendário)", "Ano (tropical)", "Ano (sidéreo)"];
factor[17] = [1, 8.640E4, 86164.09, 3600, 3590.17, 60, 60, 2628000, 0.9972696, 31536000, 31556930, 31558150];
defaultUnits[17] = ["Dia (médio solar)", "Segundo (s)"];

property[18] = "Velocidade e Velocidade";
unit[18] = ["quilômetro por segundo", "quilômetro por hora", "centímetro por segundo", "metro por segundo", "metro por minuto", "pé por segundo", "pé por minuto", "pé por hora", "milha por hora", "milha por segundo", "nó marítimo", "jarda por segundo", "nó", "mach", "velocidade da luz [ar]", "velocidade da luz [vácuo]", "velocidade do som [ar]"];
...
defaultUnits[18] = ["quilômetro por hora", "milha por hora"];

property[19] = "Viscosidade";
unit[19] = ["Newton-segundo por metro", "centipoise", "centistoke", "pé quadrado por segundo", "Poise", "poundal-segundo por pé quadrado", "libra por pé-segundo", "libra-força-segundo por pé quadrado", "rhe", "slug por pé-segundo", "stoke"];
factor[19] = [1, 0.001, 0.000001, 9.290304E-02, 0.1, 1.488164, 1.488164, 47.88026, 10, 47.88026, 0.0001];
defaultUnits[19] = ["Newton-segundo por metro", "poundal-segundo por pé quadrado"];

property[20] = "Fluxo de Volume";
unit[20] = ["barril por minuto [Reino Unido]", "barril por minuto [EUA]", "centímetro cúbico por segundo", "pé cúbico por segundo", "metro cúbico por segundo", "milímetro cúbico por segundo", "galão por segundo [Reino Unido]", "galão por segundo [EUA]", "litro por segundo", "mililitro por segundo"];
...
defaultUnits[20] = ["pé cúbico por minuto", "metro cúbico por segundo"];

property[21] = "Ângulo";
unit[21] = ["grau", "grado", "radiano", "1/10 círculo", "1/16 círculo", "1/2 círculo", "1/4 círculo", "1/6 círculo", "1/8 círculo", "minuto de arco", "grau binário", "radiano binário", "ciclo", "ângulo completo", "grado [grad]", "mil", "minuto de arco milirradiano", "milissegundo de arco", "minuto", "oitante", "ponto", "quadrante", "ângulo reto", "segundo", "sextante", "sinal", "ângulo reto"];
...
function limparResultados() {
    ...
    document.getElementById("verbose").innerHTML = "<span class='destacado'>Por favor, escolha uma grandeza física, duas unidades e em seguida insira um valor em qualquer uma das caixas acima.</span>";
}
...
function explain(qTxt, from, to, converted) {
	...
	if (invFact % 1 === 0 && float2rat_p_error(invFact, 1E-8) === 0 && invFact > 0) { // verifica se é um inteiro // invFact pode ser zero se o 'factor for muito grande ( > 10^12)
		...
		ret += "<p><span class='destacado'>Formula:</span> divide o valor em " + pluralForConverters(from, 2) + " by " + invFact + " because 1 " + to + " equals " + invFact + " " + pluralForConverters(from, 2) + ".</p>";
		...
		ret = "<p><span class='destacado'>Formula:</span> multiplique o valor em " + pluralForConverters(from, 2) + " pelo fator de conversão '" + factorTxt + "'.</p>";
...
function explainTemperature(val,from,to){
  ...
  if(from == to){
     return "Por favor, escolha duas unidades diferentes.";
  }

	var how = "<h3>Como converter " + val + " " + from + " to " + to + "?<\/h3>";
	how += "<p>Para converter de " + from + " para " + to + ", use a fórmula: <\/p><p><span class=\"formula\">" + temperatureFormula(tuple) + "<\/span><\/p>";

  if(tuple == "Celsius_Fahrenheit"){
    //"Celsius Fahrenheit":q*9/5+32,
    how += "<p>Assim, multiplicando o valor '" + val + "' in " + from + " por 9, dividindo o resultado por 5 e adicionando 32, obtemos:<\/p><p>";
    ...
    how += "<p>Assim, adicionando 273.15 ao valor '" + val + "' in " + from + ", obtemos <\/p><p>";
    how += val + " " + from + " = " + val + " + 273.15 = " + roundDec(val + 273.15,dec) + " " + to + ".";
  } else if (tuple == "Kelvin_Celsius") {
    //"Kelvin Celsius":q-273.15,
    how += "<p>Assim, subtraindo 273.15 do valor '" + val + "' in " + from + ", obtemos <\/p><p>";
    how += val + " " + from + " = " + val + " - 273.15 = " + roundDec(val - 273.15,dec) + " " + to + ".";
  } else if (tuple == "Kelvin_Fahrenheit") {
    //"Kelvin Fahrenheit":q*9/5-459.67,
    how += "<p>Assim, multiplicando o valor '" + val + "' in " + from + " por 9, dividindo o resultado por 5 e subtraindo -459.67, obtemos<\/p><p>";
    ...
    how += "<p>Assim, subtraindo 32 do valor '" + val + "' in " + from + ", multiplicando o resultado por 5 e dividindo por 9, obtemos<\/p><p>";
    ...
    how += "<p>Assim, adicionando 459.67 ao valor '" + val + "' in " + from + ", multiplicando o resultado por 5 e dividindo por 9, obtemos<\/p><p>";
...
function usableFractionsVerbose(x, from, to, qTxt) {
	...
	ret = "<h3>" + qTxt + " " + pluralForConverters(from, q) + " como uma fração utilizável ou um número inteiro em " + pluralForConverters(to, 2) + ":</h3>" + near + "<p class='compact'>Estes são valores alternativos para " + qTxt + " " + pluralForConverters(from, q) + " em " + pluralForConverters(to) + ". Eles são representados como uma fração ou um número inteiro próximo ao valor exato (<span class='fraction'><span class='top'>1</span><span class='bottom'>2</span></span>, <span class='fraction'><span class='top'>1</span><span class='bottom'>4</span></span>, <span class='fraction'><span class='top'>3</span><span class='bottom'>4</span></span> etc.). O erro de aproximação, se houver, está à direita do valor.</p>";
