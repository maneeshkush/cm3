...
property[0] = "Área";
unit[0] = ["acre","área","hectárea","centímetro cuadrado","pie cuadrado","pulgada cuadrada","kilómetro cuadrado","metro cuadrado","milla cuadrada","yarda cuadrada","pies cuadrados"];
...
defaultUnits[0] = ["acre", "milla cuadrada"];
...
property[2] = "Masa (Peso)";
unit[2] = ["tonelada","kilogramo","gramo","miligramo","tonelada [larga, RU]","tonelada [corta, EE. UU.]","quintal [largo, RU]","quintal [corto, EE. UU.]","cuarto [RU]","cuarto [EE. UU.]","slugh","piedra","libra","libra troy","onza","onza troy","Robie","dracma","dracma","punto","grano"];
...
defaultUnits[2] = ["kilogramo", "libra"];

property[3] = "Presión";
unit[3] = ["atmósfera","bar","mbar","kgf/m2","kgf/cm2","kPa","MPa","Pa","lbf/ft2","psi","torr","ksi","kilopascal [kPa]","Pascal","milímetro de mercurio [0 °C]","atmósfera [estándar]","atmósfera técnica [at]","Columna de agua [metro]","kilogramo-fuerza por metro cuadrado","dina por centímetro cuadrado","gramo-fuerza por centímetro cuadrado","kilogramo-fuerza por centímetro cuadrado","kilogramo-fuerza por milímetro cuadrado","kilopondio por metro cuadrado","milibar","newton por metro cuadrado","onza por pulgada cuadrada","libra por pie cuadrado","libra por pulgada cuadrada","poundal por pie cuadrado","atmósfera técnica","tonelada por metro cuadrado","Columna de agua [centímetro]","Columna de agua [pulgada]","Columna de agua [milímetro]"];
...
defaultUnits[3] = ["libra por pulgada cuadrada", "kilopascal [kPa]"];
...
property[5] = "Volumen y Capacidad";
unit[5] = ["metro cúbico", "litro", "litro", "centilitro", "mililitro", "cc", "centímetro cúbico", "microlitro", "taza [métrico]", "cucharada [métrico]", "cucharadita [métrico]", "barril", "balde", "barril [UK]", "balde [UK]", "bushel [UK]", "pie cúbico", "pulgada cúbica", "milla cúbica", "taza", "dracma", "quinta", "galón [líquido]", "galón [UK]", "chopito [US]", "chopito [UK]", "minim", "onza", "onza [UK, líquido]", "peck [UK]", "peck [US]", "pinta", "pinta [UK]", "cuarto", "Robie", "chupito", "cucharada", "cucharadita", "cucharada [UK]", "cucharadita [UK]"];
...
defaultUnits[5] = ["litro", "onza"];

property[6] = "Aceleración";
unit[6] = ["metro por segundo cuadrado", "pie por segundo cuadrado", "gravedad (aceleración)", "Galileo", "pulgada por segundo cuadrado"];
factor[6] = [1, 0.3048, 9.80665, 0.01, 0.0254];
defaultUnits[6] = ["metro por segundo cuadrado", "pie por segundo cuadrado"];

property[7] = "Capacitancia";
unit[7] = ["Faradio [F]", "milifaradio [mF]", "microfaradio [µF]", "nanofaradio [nF]", "picofaradio [pF]"];
factor[7] = [1, 1E-3, 1E-6, 1E-9, 1E-12];
defaultUnits[7] = ["microfaradio [µF]", "nanofaradio [nF]"];

property[8] = "Densidad y Capacidad de Masa";
unit[8] = ["gramo por centímetro cúbico", "gramo por litro", "gramo por mililitro", "kilogramo por litro", "kilogramo por metro cúbico", "tonelada por metro cúbico", "miligramo por litro", "miligramo por mililitro", "onza por pulgada cúbica", "onza por galón [UK]", "onza por galón [US]", "libra por pulgada cúbica", "libra por galón [UK]", "libra por galón [US]"];
...
defaultUnits[8] = ["kilogramo por metro cúbico", "libra por galón [US]"];

property[9] = "Carga Eléctrica";
unit[9] = ["Coulombio [C]", "abcoulombio", "Amperio-hora [A.hr]"];
factor[9] = [1, 10, 3600];
defaultUnits[9] = ["Coulombio [C]", "Amperio-hora [A.hr]"];

property[10] = "Energía";
unit[10] = ["Btu", "caloría (nutricional)", "caloría (termoquímica)", "gallón (EE. UU.) de GLP", "caballo de vapor-hora", "Joule", "kilogramo-fuerza metro", "kilovatio-hora", "tonelada (explosiva)", "vatio-hora"];
factor[10] = [1055.0559, 4186.8, 4.184, 100757838.45, 2684519.5, 1, 9.80665, 3600000, 4184000000, 3600];
defaultUnits[10] = ["Joule", "kilovatio-hora"];

property[11] = "Fuerza";
unit[11] = ["Newton (N)", "Dina (dy)", "Kilogramo fuerza (kgf)", "Kilopondio (kpf)", "Kip (k)", "Onza fuerza (ozf)", "Libra fuerza (lbf)", "Poundal"];
factor[11] = [1, 0.00001, 9.806650, 9.806650, 4448.222, 0.2780139, 4.4482216, 0.138255];
defaultUnits[11] = ["Kilogramo fuerza (kgf)", "Newton (N)"];

property[12] = "Fuerza / Longitud";
unit[12] = ["Newton por metro (N/m)", "libra fuerza por pulgada (lbf/in)", "libra fuerza por pie (lbf/ft)"];
factor[12] = [1, 175.1268, 14.5939];
defaultUnits[12] = ["Newton por metro (N/m)", "libra fuerza por pulgada (lbf/in)"];

property[13] = "Iluminancia";
unit[13] = ["lumen/m² (lu/m²)","lumen/cm²","lumen/ft²","pie-vela (ft-cdl)","pie-lambert","candela/m²","candela/cm²","lux (lx)","nox (nx)","fot (ph)"];
factor[13] = [1,10000,10.76391,10.76391,10.76391,3.141592505,31415.92505,1,-328716,10000];
defaultUnits[13] = ["lumen/m² (lu/m²)","lumen/pie²"];

property[14] = "Flujo de Masa";
unit[14] = ["kilogramo por segundo (kg/s)","libra masa por segundo (lbm/s)","libra masa por minuto (lbm/min)"];
factor[14] = [1, 0.4535924, 0.007559873];
defaultUnits[14] = ["kilogramo por segundo (kg/s)", "libra masa por segundo (lbm/s)"];

property[15] = "Potencia";
unit[15] = ["Btu/hora","caloría/hora","gigavatio","caballo de fuerza (eléctrico)","caballo de fuerza (internacional)","caballo de fuerza (métrico)","caballo de fuerza (agua)","kilocaloría/hora","kilovatio","megavatio","microwatio","miliwatio","tonelada de refrigeración","vatio"];
...
defaultUnits[15] = ["caballo de fuerza (eléctrico)","vatio"];

property[16] = "Torque";
unit[16] = ["Newton-metro (N.m)","dina-centímetro (dy.cm)","kgf-metro (kgf.m)","lbf-pulgada (lbf.in)","lbf-pie (lbf.ft)"];
factor[16] = [1, 0.0000001, 9.806650, 0.1129848, 1.355818];
defaultUnits[16] = ["Newton-metro (N.m)","kgf-metro (kgf.m)"];

property[17] = "Tiempo";
unit[17] = ["Segundo (seg)", "Día (solar medio)", "Día (sidéreo)", "Hora (solar medio)", "Hora (sidérea)", "Minuto (solar medio)", "Minuto (sidéreo)", "Mes (calendario medio)", "Segundo (sidéreo)", "Año (calendario)", "Año (tropical)", "Año (sidéreo)"];
factor[17] = [1, 8.640E4, 86164.09, 3600, 3590.17, 60, 60, 2628000, 0.9972696, 31536000, 31556930, 31558150];
defaultUnits[17] = ["Día (solar medio)", "Segundo (seg)"];

property[18] = "Velocidad";
unit[18] = ["kilómetro por segundo", "kilómetro por hora", "centímetro por segundo", "metro por segundo", "metro por minuto", "pie por segundo", "pie por minuto", "pie por hora", "milla por hora", "milla por segundo", "milla náutica por hora", "yarda por segundo", "nudo", "mach", "velocidad de la luz [aire]", "velocidad de la luz [vacío]", "velocidad del sonido [aire]"];
...
defaultUnits[18] = ["kilómetro por hora", "milla por hora"];

property[19] = "Viscosidad";
unit[19] = ["Newton-segundo por metro", "centipoise", "centistoke", "pie cuadrado por segundo", "Poise", "libra-pie-segundo por pie cuadrado", "libra masa por pie-segundo", "libra-fuerza-segundo por pie cuadrado", "rhe", "slug por pie-segundo", "stoke"];
factor[19] = [1, 0.001, 0.000001, 9.290304E-02, 0.1, 1.488164, 1.488164, 47.88026, 10, 47.88026, 0.0001];
defaultUnits[19] = ["Newton-segundo por metro", "libra-pie-segundo por pie cuadrado"];

property[20] = "Flujo de Volumen";
unit[20] = ["barril por minuto [RU]", "barril por minuto [EE. UU.]", "centímetro cúbico por segundo", "pie cúbico por segundo", "metro cúbico por segundo", "milímetro cúbico por segundo", "galón por segundo [RU]", "galón por segundo [EE. UU.]", "litro por segundo", "mililitro por segundo"];
...
defaultUnits[20] = ["pie cúbico por minuto", "metro cúbico por segundo"];

property[21] = "Ángulo";
unit[21] = ["grado", "grad", "radián", "1/10 de círculo", "1/16 de círculo", "1/2 de círculo", "1/4 de círculo", "1/6 de círculo", "1/8 de círculo", "minuto de arco", "grado binario", "radián binario", "ciclo", "ángulo completo", "gradiente [grad]", "mil", "minuto de arco milirradian", "milisegundo de arco", "minuto", "octante", "punto", "cuadrante", "ángulo recto", "segundo de arco", "sextante", "signo", "ángulo recto"];
...
function clearResults() {
    ...
    document.getElementById("verbose").innerHTML = "<span class='destacado'>Por favor, elija una magnitud física, dos unidades y luego introduzca un valor en cualquiera de las casillas de arriba.</span>";
}
...
function explain(qTxt, from, to, converted) {
    ...
    var ret = "";
    if (q == 0) { return ""; } // no se puede calcular el 'factor'

    var factor = parseFloat((converted / q).toPrecision(14)); // parseFloat elimina los ceros a la derecha.
    // 14 es la longitud del número devuelto por la función en el archivo xxxxx-unit-process.php
    var factorTxt = conversionFactorTxt(factor, 1E-8);
    var inv = 1 / factor;
    var invFact = roundDec(inv, 12);

    if (invFact % 1 === 0 && float2rat_p_error(invFact, 1E-8) === 0 && invFact > 0) { // verifica si es un número entero // invFact puede ser cero si el 'factor' es muy grande ( > 10^12)

        ret += "<p><span class='destacado'>Fórmula:</span> divide el valor en " + pluralForConverters(from, 2) + " por " + invFact + " porque 1 " + to + " equivale a " + invFact + " " + pluralForConverters(from, 2) + ".</p>";

        ret += "<p>Entonces, " + qTxt + " " + pluralForConverters(from, q) + " = <span class='fraction'><span class='top'>" + qTxt + "</span><span class='bottom'>" + invFact + "</span></span> = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? (" o <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";

    } else {

        ret = "<p><span class='destacado'>Fórmula:</span> multiplica el valor en " + pluralForConverters(from, 2) + " por el factor de conversión '" + factorTxt + "'.</p>";

        ret += "<p>Entonces, " + qTxt + " " + pluralForConverters(from, q) + " = " + qTxt + " × " + factorTxt + " = <span class='destacado'>" + bestFmt(converted, 14) + "</span> " + (bestFmt(converted, 14) != converted ? (" o <span class='destacado'>" + converted + "</span> ") : "") + pluralForConverters(to, converted) + ".</p>";
...
function explainTemperature(val, from, to) {
    ...
    if (from == to) {
        return "Por favor, elija dos unidades diferentes.";
    }

    var how = "<h3>Cómo convertir " + val + " " + from + " a " + to + "?</h3>";
    how += "<p>Para convertir de " + from + " a " + to + ", utilice la fórmula:</p><p><span class=\"formula\">" + temperatureFormula(tuple) + "</span></p>";

    if (tuple == "Celsius_Fahrenheit") {
        // "Celsius Fahrenheit": q*9/5+32,
        how += "<p>Así que, multiplicando el valor '" + val + "' en " + from + " por 9, dividiendo el resultado por 5 y luego sumando 32, obtenemos:</p><p>";
        ...
        how += "<p>Así que, sumando 273.15 al valor '" + val + "' en " + from + ", obtenemos:</p><p>";
        how += val + " " + from + " = " + val + " + 273.15 = " + roundDec(val + 273.15, dec) + " " + to + ".";
    } else if (tuple == "Kelvin_Celsius") {
        // "Kelvin Celsius": q-273.15,
        how += "<p>Así que, restando 273.15 al valor '" + val + "' en " + from + ", obtenemos:</p><p>";
        how += val + " " + from + " = " + val + " - 273.15 = " + roundDec(val - 273.15, dec) + " " + to + ".";
    } else if (tuple == "Kelvin_Fahrenheit") {
        // "Kelvin Fahrenheit": q*9/5-459.67,
        how += "<p>Así que, multiplicando el valor '" + val + "' en " + from + " por 9, dividiendo el resultado por 5 y restando -459.67, obtenemos:</p><p>";
        ...
        how += "<p>Así que, restando 32 al valor '" + val + "' en " + from + ", multiplicando el resultado por 5 y dividiendo el resultado por 9, obtenemos:</p><p>";
        ...
        how += "<p>Así que, sumando 459.67 al valor '" + val + "' en " + from + ", multiplicando el resultado por 5 y dividiendo por 9, obtenemos:</p><p>";
...
function usableFractionsVerbose(x, from, to, qTxt) {
	...
	ret = "<h3>" + qTxt + " " + pluralForConverters(from, q) + " como fracción utilizable o entero en " + pluralForConverters(to, 2) + ":</h3>" + near + "<p class='compact'>Estos son valores alternativos para " + qTxt + " " + pluralForConverters(from, q) + " en " + pluralForConverters(to) + ". Se representan como una fracción o un entero cerca del valor exacto (<span class='fraction'><span class='top'>1</span><span class='bottom'>2</span></span>, <span class='fraction'><span class='top'>1</span><span class='bottom'>4</span></span>, <span class='fraction'><span class='top'>3</span><span class='bottom'>4</span></span> etc.). El error de aproximación, si lo hay, está a la derecha del valor.</p>";
